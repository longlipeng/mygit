	...
	<body>
									  ...
									  <td>
									    <table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="bankDTO.bankName" maxlength="32"
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="bankDTO.bankAccount" maxlength="32"
									  ...
									  <td>
									    <table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="bankDTO.bankAccountName" maxlength="32"
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="bankDTO.bankAccountCode" maxlength="128"
		...
		<div id="btnDiv" style="text-align: right; width: 100%">
			...
			<button class='bt' style="float: right; margin: 5px"
				onclick="document.newForm.action='${ctx}/merchantManagement/insertBank.action';newForm.submit();">
				提 交
			</button>
