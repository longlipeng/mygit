...
<script type="text/javascript">
  function subedit(){
		document.invoiceAddressForm.action="${ctx}/customer/updateAddress.action";
		document.invoiceAddressForm.submit();
		}
</script>
...
<body>
    ...
    <s:form id="invoiceAddressForm" name="invoiceAddressForm" action=" " method="post">
    	<s:hidden name="invoiceAddressDTO.entityId" />
                ...
                <table width="100%" style="table-layout: fixed;">
                    ...
                    <tr>
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    <td style="width: 110px; text-align: right;">是否默认发票地址</td>
                                    <td>
                                        <s:radio list="#{1: '是', 0: '否'}" name="invoiceAddressDTO.defaultFlag"></s:radio>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <tr>
                    <td align="right">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <input type="submit" class="bt" style="margin: 5px" value="提 交" onclick="subedit()"/>
                                </td>
                                <td>
