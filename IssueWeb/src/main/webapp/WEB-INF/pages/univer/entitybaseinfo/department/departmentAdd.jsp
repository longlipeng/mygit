...
<body>
    ...
    <s:form id="departmentForm" name="departmentForm" action="customer/insertDepartment.action" method="post">
                ...
                <table width="100%" style="table-layout: fixed;">
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td><s:textfield name="departmentDTO.departmentName" maxlength="128"/>
                                        <s:fielderror>
                    ...
                    <tr>
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    <td style="width: 90px; text-align: right;">是否默认部门</td>
                                    <td>
                                        <s:radio list="#{1: '是', 0: '否'}" name="departmentDTO.defaultFlag" value="1"></s:radio>
                                    </td>
                                </tr>
                            </table>
                        </td>
