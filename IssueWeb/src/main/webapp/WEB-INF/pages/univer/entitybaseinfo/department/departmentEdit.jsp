...
<body>
    ...
    <s:form id="departmentForm" name="departmentForm" action="customer/updateDepartment.action" method="post">
      <s:hidden name="departmentDTO.entityId" />
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <s:radio list="#{1: '是', 0: '否'}" name="departmentDTO.defaultFlag"></s:radio>
                                    </td>
                                </tr>
                            </table>
                        </td>
