...
<body>
    ...
    <s:form id="invoiceAddressForm" name="invoiceAddressForm" action="customer/insertAddress.action" method="post">
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <s:radio list="#{1: '是', 0: '否'}" name="invoiceAddressDTO.defaultFlag" value="1"></s:radio>
                                    </td>
                                </tr>
                            </table>
                        </td>
