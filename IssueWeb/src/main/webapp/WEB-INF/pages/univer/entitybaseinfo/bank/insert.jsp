	...
	<body>
												...
												<tr>
													...
													<td>
														<s:textfield name="bankDTO.bankName"
															id="bankDTO.bankName" maxlength="32"></s:textfield>
														<s:fielderror>
															<s:param>
																bankDTO.bankName
															</s:param>
												...
												<tr>
													...
													<td>
														<s:textfield name="bankDTO.bankAccount"
															id="bankDTO.bankAccount" maxlength="32"></s:textfield>
														<s:fielderror>
															<s:param>
																bankDTO.bankAccount
															</s:param>
												...
												<tr>
													...
													<td>
														<s:textfield name="bankDTO.bankAccountName"
															id="bankDTO.bankAccountName" maxlength="32"></s:textfield>
														<s:fielderror>
															<s:param>
									  ...
									  <td>
									    <table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:radio list="#{'0':'否','1':'是'}" name="bankDTO.accountFlag" value="1"></s:radio>
													</td>
												</tr>
										  </table>
										</td>
		...
		<div id="btnDiv" style="text-align: right; width: 100%">
			...
			<button class='bt' style="float: right; margin: 5px"
				onclick="document.newForm.action='${ctx}/customer/insertBank.action';newForm.submit();">
				提 交
			</button>
