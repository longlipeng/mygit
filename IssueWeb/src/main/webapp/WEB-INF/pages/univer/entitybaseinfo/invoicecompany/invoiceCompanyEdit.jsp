...
<script type="text/javascript">
  function subedit(){
		document.invoiceCompanyForm.action="${ctx}/customer/updateCompany.action";
...
<body>
    ...
    <s:form id="invoiceCompanyForm" name="invoiceCompanyForm" action="" method="post">
		<s:hidden name="invoiceCompanyDTO.entityId" />
		<s:hidden name="invoiceCompanyDTO.invoiceCompanyId" />
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                         <s:radio list="#{1: '是', 0: '否'}" name="invoiceCompanyDTO.defaultFlag"></s:radio>
                                    </td>
                                </tr>
                            </table>
                        </td>
