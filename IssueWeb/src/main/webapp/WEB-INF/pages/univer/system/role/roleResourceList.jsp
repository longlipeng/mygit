...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function edit(){
			...
			if(n==1){
				document.EditForm.action='roleResource/roleLoad.action?id='+roleId;
		...
		function operation(){
				EditForm.action='roleResource/roleDel.action';
				EditForm.submit();
		}
	</script>
		<style type="text/css">
			...
			<table width="98%" border="0" cellpadding="0" cellspacing="1"
				...
				<tr>
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="QueryBody">
							<s:form id="queryForm" name="queryForm" action="roleList"
								method="post">
			...
			<table width="98%" border="0" cellpadding="0" cellspacing="1"
				...
				<tr>
					<td width="98%" height="10" align="center" valign="middle"
						...
						<div id="TableBody">
							<s:form id="EditForm" name="EditForm" action="roleResource/roleList.action"
								method="post">
								<s:hidden name="roleQueryDTO.roleId"></s:hidden>
								<s:hidden name="roleQueryDTO.roleName"></s:hidden>
								<ec:table items="pageDataDTO.data" var="map" width="100%"
									form="EditForm" action="roleResource/roleList.action"
									imagePath="${ctx}/images/extremecomponents/*.gif" view="html"
									retrieveRowsCallback="limit" autoIncludeParameters="false">
									<ec:row ondblclick="view('roleResource/roleView.action',{'id':'${map.roleId}'},'');">
										<ec:column property="null" alias="choose" title="选择"
											width="10%"  headerCell="selectAll">
											<input type="checkbox" name="choose" value="${map.roleId},${map.entityId}" />
										</ec:column>
										<ec:column property="roleId"    title="角色号" width="15%">
											<a href="roleResource/roleView.action?id=${map.roleId}">${map.roleId}</a>
										</ec:column>
												...
												valign="middle">
													...
													<display:security urlId="60201">
														<div id="addBtn" class="btn"
															...
															onclick="EditForm.action='roleResource/addResource.action';EditForm.submit();">
															添加
														</div>
														</display:security >
