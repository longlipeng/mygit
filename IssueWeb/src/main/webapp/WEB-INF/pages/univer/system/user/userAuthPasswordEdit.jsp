...
.x-tree-node-icon {
	display: none;
		...
		function sub(){
				maskDocAll();
				document.newForm.action="user/modifyAuthPassword.action";
								...
								<table width="100%" style="table-layout: fixed;">
									...
									<tr>
										...
										<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 110px; text-align: right;">
														<span class="no-empty">*</span>新授权密码：
													</td>
													<td>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 150px; text-align: right;">
														<span class="no-empty">*</span>新授权密码确认：
													</td>
													<td>
														<s:password name="authRepassword" id="authRepassword"></s:password>
														<s:fielderror>
															<s:param>
																authRepassword
															</s:param>
