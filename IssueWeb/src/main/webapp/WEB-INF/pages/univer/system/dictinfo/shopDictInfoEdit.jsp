										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:hidden name="dictInfoDTO.dictTypeCode"/>
														<s:textfield name="dictInfoDTO.dictTypeName"  id="dictInfoDTO.dictTypeName" readonly="true"/>																			
														<s:fielderror>
															<s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														 <edl:entityDictList displayName="dictInfoDTO.fatherDictId" dictValue="${dictInfoDTO.fatherDictId}"  dictType="107" tagType="2" defaultOption="false"  /> tagType="2" defaultOption="false"  />						
													</td>
												</tr>
											</table>
										</td>
