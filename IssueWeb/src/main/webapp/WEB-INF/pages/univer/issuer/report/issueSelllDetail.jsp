...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<s:form id="queryForm" name="queryForm"
			action="/ireport/queryissueSelllDetail!viewReport.action" method="post">
			<s:hidden name="sellerIssueSellDetailDTO.reportName" id="name"></s:hidden>
								<s:hidden name="sellerIssueSellDetailDTO.reportType"></s:hidden>
								<s:hidden name="sellerIssueSellDetailDTO.sellerId"></s:hidden>
								<s:hidden name="sellerIssueSellDetailDTO.sellerName"></s:hidden>
								<s:hidden name="sellerIssueSellDetailDTO.reportFileName"></s:hidden>
			<div id="base"
						...
						<tr>
							...
							<table style="text-align: right; width: 100%">
									<tr>
										...
										<td align="left">
											<s:textfield name="sellerIssueSellDetailDTO.startDate" id="startDate"
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td align="left">
											<s:textfield name="sellerIssueSellDetailDTO.endDate" id="endDate"
												 size="20" onfocus="dateClick(this)"
												cssClass="Wdate">
											</s:textfield>
											<s:fielderror>
