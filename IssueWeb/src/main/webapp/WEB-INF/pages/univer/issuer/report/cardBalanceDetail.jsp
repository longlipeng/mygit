					...
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="QueryBody">
							<s:form id="queryForm" name="queryForm"
								action="/ireport/queryCardBalanceDetail!downLoad.action" method="post">
								<s:hidden name="cardBalanceDatailDTO.reportName"></s:hidden>
								<s:hidden name="cardBalanceDatailDTO.reportType"></s:hidden>
								<s:hidden name="cardBalanceDatailDTO.issuerId"></s:hidden>
								<s:hidden name="cardBalanceDatailDTO.issuerName"></s:hidden>
								<s:hidden name="cardBalanceDatailDTO.reportFileName"></s:hidden>
										...
										<td width="50%" align=left>
											<table style="text-align: right; width: 100%">
												<tr>
													...
													<td align="left">
														<s:textfield name="cardBalanceDatailDTO.startDate" id="startDate"
										...
										<td width="50%" align="left">
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td align="left">
														<s:textfield name="cardBalanceDatailDTO.endDate" id="endDate"
															size="20" onfocus="dateClick(this)" cssClass="Wdate">
														</s:textfield>
														<s:fielderror>
