...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<s:form id="queryForm" name="queryForm"
			action="/ireport/queryCardInvalid!viewReport.action" method="post">
			<s:hidden name="cardInvalidDTO.reportName" id="name"></s:hidden>
			<s:hidden name="cardInvalidDTO.reportType"></s:hidden>
			<s:hidden name="cardInvalidDTO.issuerId"></s:hidden>
			<s:hidden name="cardInvalidDTO.issuerName"></s:hidden>
			<s:hidden name="cardInvalidDTO.reportFileName"></s:hidden>
			<div id="base"
							...
							<td>
								<table width="100%">
									<tr>
										...
										<td>
											<s:select name="cardInvalidDTO.entityId" list="sellerQueryDTOs"  listKey="entityId" 
							...
							<td>
								<table style="text-align: right; width: 100%">
									<tr>
										...
										<td align="left">
											<s:textfield name="cardInvalidDTO.startDate" id="startDate"
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td align="left">
											<s:textfield name="cardInvalidDTO.endDate" id="endDate"
												size="20" onfocus="dateClick(this)" cssClass="Wdate">
											</s:textfield>
											<s:fielderror>
