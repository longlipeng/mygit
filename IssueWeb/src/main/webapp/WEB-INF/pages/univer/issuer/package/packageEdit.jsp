										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="packageDTO.packageId" readonly="true"></s:textfield>
														<s:fielderror>
															<s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="packageDTO.packageName"></s:textfield>
														<s:fielderror>
															<s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="packageDTO.packageFee"/>元
														<s:fielderror>
															<s:param>
