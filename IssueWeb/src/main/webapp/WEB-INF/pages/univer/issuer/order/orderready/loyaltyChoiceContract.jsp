...
<script type="text/javascript">
    ...
    function loadPage() {
        var sellerContractDTOData = ${loyaltyContractDTOs};
    ...
    function choiceSellContract() {
        ...
        if (selectContractSeller != '') {
        	...
        	document.getElementById('sellContractId').value=sellerContractDTOs[selectContractSeller]['loyaltyContractId'];
    ...
    function submitForm(){
    	...
    	document.buyOrderForm.action="${ctx}/stockOrderReadyAction!insertLoyaltyOrder";
...
<body onload="loadPage();">
    ...
    <s:form name="buyOrderForm" id="buyOrderForm" action="" method="post">
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <s:select list="loyaltyContractDTOs" listKey="contractSeller" listValue="contractSellerName" name="selectContractSeller" id="selectContractSeller" headerKey="" headerValue="--请选择--" onchange="choiceSellContract()" value=""/>
                                    </td>
                                </tr>
                            </table>
                        </td>
        ...
        <br/>
       	<!-- 订单明细 -->
       	<c:if test="${loyaltyOrderList_totalRows > 0}">
