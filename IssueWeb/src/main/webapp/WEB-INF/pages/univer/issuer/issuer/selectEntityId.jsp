						  ...
						  <s:form id="queryForm" name="queryForm"
			                ...
			                <table>
									...
									<tr height="35">
										...
										<td width="160">
											<s:textfield name="issuerQueryDTO.queryEntityId" id='entityId'></s:textfield>
											&nbsp;
										</td>
										...
										<td width="160">
											<s:textfield name="issuerQueryDTO.queryName"/>
											&nbsp;
										</td>
									</tr>
									<tr>
										...
										<td width="120">
											<s:select list="#{'1':'营销机构','2':'收单机构'}"
												name="issuerQueryDTO.entityFlag" emptyOption="false"
				...
				<tr>
					<td width="98%" height="10" align="center" valign="middle"
						...
						<s:form id="EditForm" name="EditForm"
								...
								<s:hidden name="issuerQueryDTO.queryName"/>
								<s:hidden name="issuerQueryDTO.queryEntityId"/>
								<s:hidden name="issuerQueryDTO.entityFlag"/>
