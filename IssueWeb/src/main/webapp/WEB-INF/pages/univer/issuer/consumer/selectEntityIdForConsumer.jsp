					...
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="QueryBody">
						  <s:form id="queryForm" name="queryForm"
								action="consumer/record.action" method="post">
			                <table>
									...
									<tr height="35">
										...
										<td width="160">
											<s:textfield name="consumerQueryDTO.queryEntityId" id='entityId'></s:textfield>
											&nbsp;
										</td>
										...
										<td width="160">
											<s:textfield name="consumerQueryDTO.queryName"/>
											&nbsp;
										</td>
									</tr>
									<tr>
										...
										<td width="120">
											<s:select list="#{'1':'发卡机构','2':'营销机构'}"
												name="consumerQueryDTO.entityFlag" emptyOption="false"
				...
				<tr>
					<td width="98%" height="10" align="center" valign="middle"
						...
						<s:form id="EditForm" name="EditForm"
								action="consumer/record" method="post">
								<s:hidden name="consumerQueryDTO.queryName"/>
								<s:hidden name="consumerQueryDTO.queryEntityId"/>
								<s:hidden name="consumerQueryDTO.entityFlag"/>
							<ec:table items="pageDataDTO.data" var="map" width="100%"
								form="EditForm"
								action="${ctx}/consumer/record"
