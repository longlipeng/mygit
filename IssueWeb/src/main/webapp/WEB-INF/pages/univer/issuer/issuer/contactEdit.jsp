...
<script language="javaScript">
 function sub(){
      ...
      document.customerContactForm.action="contactUpdate.action";
...
<body>
    ...
    <s:form id="customerContactForm" name="customerContactForm" action="" method="post">
        ...
        <s:hidden name="contactDTO.contactId"></s:hidden>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                    	<s:radio list="#{'0':'否','1':'是'}" name="contactDTO.defaultFlag"></s:radio>
                                   <!-- 
                        ...
                        <td colspan="2">
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                    <s:select list="#{'1':'有效', '0':'无效'}" name="contactDTO.validityFlag"></s:select></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
