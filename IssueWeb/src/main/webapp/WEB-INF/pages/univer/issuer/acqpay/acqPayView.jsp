									  ...
									  <td>
									    <table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="acqPayDTO.certs" readonly="true"></s:textfield>
														<s:fielderror>
															<s:param>
																acqPayDTO.certs
															</s:param>
...
<!--													</td>-->
<!--													<td>-->
<!--														<s:password name="acqPayDTO.certsPwd" readonly="true"></s:password>-->
<!--														<s:fielderror>-->
<!--															<s:param>-->
<!--																acqPayDTO.certsPwd-->
<!--															</s:param>-->
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
													    <s:textfield name="acqPayDTO.logo" readonly="true"></s:textfield>
														<s:fielderror>
															<s:param>
																acqPayDTO.logo
															</s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="acqPayDTO.copyright" readonly="true"/>
														<s:fielderror>
															<s:param>
																acqPayDTO.copyright
															</s:param>
									...
									<tr>
									  ...
									  <table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield id="acqPayDTO.insNm" name="acqPayDTO.insNm" readonly="true"></s:textfield>
														<s:fielderror>
															<s:param>
																acqPayDTO.insNm
															</s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield id="acqPayDTO.domainUrl" name="acqPayDTO.domainUrl" readonly="true"></s:textfield>
														<s:fielderror>
															<s:param>
																acqPayDTO.domainUrl
															</s:param>
