...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<s:form id="sendForm" name="sendForm"
								action="stockOrderSendAction!list">
			...
			<table width="98%" border="0" cellpadding="0" cellspacing="1"
				...
				<tr>
					<td width="98%" height="10" align="center" valign="middle"
						...
						<ec:table items="sellOrders" var="map" width="100%" form="sendForm"
							action="${ctx}/${actionName}!list"
							imagePath="${ctx}/images/extremecomponents/*.gif" view="html"
							retrieveRowsCallback="limit" tableId="sellOrder" autoIncludeParameters="false">
							<ec:exportXls fileName="stockOrderSendList.xls" tooltip="导出Excel" />
				...
				<tr>
					<td width="98%" height="10" align="center" valign="middle"
						bgcolor="#FFFFFF">
							...
							<s:form id="EditForm" name="EditForm" action="stockOrderSendAction!operateReady">
