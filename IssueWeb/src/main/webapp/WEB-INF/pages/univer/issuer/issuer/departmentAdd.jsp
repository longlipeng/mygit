...
<body>
    ...
    <s:form id="departmentForm" name="departmentForm" action="departmentInsert.action" method="post">
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
											<s:radio list="#{'0':'否','1':'是'}" name="departmentDTO.defaultFlag" value="1"></s:radio>
                                    </td>
                                </tr>
                            </table>
                        </td>
