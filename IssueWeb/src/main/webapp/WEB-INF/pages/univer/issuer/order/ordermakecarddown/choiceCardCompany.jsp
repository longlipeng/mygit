...
<script type="text/javascript">
    ...
    function choiceCardCompany() {
        ...
        if (selectedCardCompanyId != '') {
        	document.getElementById('companyId').value=selectedCardCompanyId;
            ...
            document.getElementById('isIcCard').innerHTML = cardCompanys[selectedCardCompanyId]['isIcCard'] == 1 ? '否' : '是';
            document.getElementById('isMsCard').innerHTML = cardCompanys[selectedCardCompanyId]['isMsCard'] == 1 ? '否' : '是';
    ...
    function submitForm(){
    	...
    	document.makeCardForm.action="stockOrderMakeCardDownAction!list";
...
<body onload="loadPage()">
    ...
    <s:form name="makeCardForm" id="makeCardForm" action="" method="post">
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <s:select list="sellOrderMakeCardDTO.cardCompanyList" listKey="cardCompanyId" listValue="cardCompanyName" name="cardCompanyId" id="cardCompanyId"  onchange="choiceCardCompany()" value=""></s:select>
                                    </td>
                                </tr>
                            </table>
                        </td>
