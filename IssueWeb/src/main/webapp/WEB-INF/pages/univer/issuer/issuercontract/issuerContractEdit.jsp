...
<script type="text/javascript">
	...
	function addProduct(){
		...
		var returnValue = window.showModalDialog('${ctx}/addProductService.action?layaltyContractDTO.loyaltyContractId='+sellerContractId+'&layaltyContractDTO.contractBuyer='+${layaltyContractDTO.contractBuyer}, '_blank', 'center:yes;dialogHeight:600px;dialogWidth:700px;resizable:no');
	...
	function sub(){
    	...
    	document.contractForm.action = '${ctx}/updateIssuerConstract.action';
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td><s:textfield id="contractBuyer" name="layaltyContractDTO.contractBuyer" readonly="true" />
                                        <s:fielderror>
