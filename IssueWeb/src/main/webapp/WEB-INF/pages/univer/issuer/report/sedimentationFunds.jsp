...
function  submitForm(){
			var startDateString = document.getElementById('queryDate').value;
	...
	<body>
		...
		<s:form id="queryForm" name="queryForm"
			action="/ireport/querySedimentationFunds!viewReport.action" method="post">
							...
							<td>
								<table style="text-align: right; width: 55%">
									<tr>
										...
										<td>
											<s:textfield name="fundSubsideSumDTO.queryDate" id="queryDate"
