	...
	<head>
		...
		function  submitForm(){
			...
			$("#button1").removeAttr("class");
				queryForm.action="${ctx}/batchfile/batchRecharge.action";
		...
		function backForm(){
			queryForm.action="${ctx}/batchfile/batchRechargeListAction.action";
			document.queryForm.submit();
		}
</script>
	</head>
								...
								<table style="text-align: right; width: 55%">
									<tr>
										...
										<td width="35%" align="left" nowrap="nowrap">
											<s:textfield name="batchRechargeDTO.countNum" id="countNum" maxlength="50"/>
										</td>
									</tr>
