...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function choiceCustomer() {
	    ...
	    var sellerDTO = window.showModalDialog(
				'customerManagement/choice.action', '_blank',
	...
	function loadPage() {
        var entityId = document.getElementById('sellerForm_sellerDTO_entityId').value;
        var fatherEntityId = document.getElementById('sellerForm_sellerDTO_fatherEntityId').value;
        //一级营销机构不能选择上级营销机构编辑
        if(entityId == fatherEntityId) {
        	document.getElementById('chooseLastSellerBtn').disabled = true;
        }
        else {
        	document.getElementById('chooseLastSellerBtn').disabled = false;
        }
	...
	function reload() {
		document.sellerForm.action = "${ctx}/issuerSeller/edit.action";
	...
	function updateEntity(entityForm, chooseId) {
		...
		if (n == 1) {
			...
			var returnValue = window
					.showModalDialog(
							'${ctx}/${nameSpace}/editDeliveryPoint.action?deliveryPointDTO.deliveryId=' + deliveryId + '&nameSpace=${nameSpace}&entityId=${entityId}',
							'_ blank',
				...
				for ( var i = 0; i < menuList.length; i++) {
					if (parseInt(menuList[i]['fatherResourceId']) == 0) {
						...
						case 2:
							...
							nodeObject[menuList[i]['fatherResourceId']]
									.appendChild(nodeObject[menuList[i]['resourceId']]);
							break;
						case 3:
							nodeObject[menuList[i]['resourceId']] = new Ext.tree.TreeNode(
									{
	...
	function getAllParentNodes(node) {
		...
		if (node.parentNode) {
			parentNodes = parentNodes
					.concat(getAllParentNodes(node.parentNode));
		}
		return parentNodes;
	}
	...
	function sub() {
		...
		sellerForm.action = "${ctx}/issuerSeller/update.action";
		sellerForm.submit();
	}
	...
	function openSellerPage() {
		...
		if (returnValue == null || returnValue == undefined)
			return;
		sellerForm.action = "${ctx}/issuerSeller/edit.action?faEntityId="+returnValue;
		sellerForm.submit();
	}
</script>
	</head>
											...
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>营销机构名称：
													</td>
													<td>
														<s:textfield name="sellerDTO.sellerName" id="sellerName" maxlength="128"/>
														<s:fielderror>
															<s:param>sellerDTO.sellerName</s:param>
														</s:fielderror>
														<span style="color:red;display: none;" >请录入机构所属公司的公司名称</span>
													</td>
												</tr>
											</table>
										</td>
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="sellerDTO.sellerEnglishName" maxlength="128"/>
														<s:fielderror>
									...
									<tr>
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>营销机构地址：
													</td>
													<td>
														<s:textfield name="sellerDTO.sellerAddress" maxlength="128"/>
														<s:fielderror>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="sellerDTO.sellerEnglishAddress" maxlength="128"/>
														<s:fielderror>
									...
									<tr>
				  						<td>
				                            <table style="text-align: left; width: 100%">
				                               <tr>
				                                   ...
				                                   <td>
				                                       <s:textfield  name="sellerDTO.newFatherEntityId" size="20" readonly="true" maxlength="128"/>
				                                   	   <input id="chooseLastSellerBtn" type="button" value="选择营销机构" onclick="openSellerPage();"/>
				                                       <s:fielderror>
				                                          <s:param>sellerDTO.newFatherEntityId</s:param>
				                                       </s:fielderror>
				                                  </td>
				                              </tr>
				                            </table>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>营销机构传真：
													</td>
													<td>
									...
									<tr>
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>营销机构邮编：
													</td>
													<td>
														<s:textfield name="sellerDTO.sellerPostcode" maxlength="128"/>
														<s:fielderror>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>营销机构电话：
													</td>
													<td>
														<s:textfield name="sellerDTO.sellerTelephone" maxlength="12"/>
														<s:fielderror>
									...
									<tr>
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>营销机构规模：
													</td>
													<td>
														<s:textfield name="sellerDTO.sellerSize" maxlength="128"/>
														<s:fielderror>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="sellerDTO.sellerWebsite" maxlength="128"/>
														<s:fielderror>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="sellerDTO.externalId" maxlength="128"/>
														<s:fielderror>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="sellerDTO.legCusId" maxlength="128"/>
														<s:fielderror>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="sellerDTO.printName" maxlength="128"/>
														<s:fielderror>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="sellerDTO.extPrintInfo" maxlength="128"/>
														<s:fielderror>
									...
									<tr>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>销售区域：
													</td>
													<td>
														<edl:entityDictList displayName="sellerDTO.salesRegionId"
															dictValue="${sellerDTO.salesRegionId}" dictType="407"
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>是否发送DM：
													</td>
													<td>
														<s:select list="#{'1':'是', '0':'否'}"
															name="sellerDTO.hasDm"></s:select>
														<s:fielderror>
									...
									<tr>
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>缺省支付节点：
													</td>
													<td>
														<dl:dictList displayName="sellerDTO.paymentTerm"
															dictValue="${sellerDTO.paymentTerm}" dictType="207"
															tagType="2" defaultOption="false"
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="sellerDTO.paymentDelay" 
									...
									<tr>
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>营业城市：
													</td>
													<td>
														<edl:entityDictList displayName="sellerDTO.businessCity"
															dictValue="${sellerDTO.businessCity}" dictType="405"
															tagType="2" defaultOption="false"
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>营业区域：
													</td>
													<td>
														<select name="sellerDTO.businessAreaId" id="businessArea">
														</select>
														<s:fielderror>
									...
									<tr>
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>销售人员：
													</td>
													<td>
														<s:select list="salesmanList" name="sellerDTO.salesmanId"
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 100px; text-align: right;">
														<span class="no-empty">*</span>营销机构行业：
													</td>
													<td>
														<edl:entityDictList displayName="sellerDTO.activitySector"
															dictValue="${sellerDTO.activitySector}" dictType="400"
															tagType="2" defaultOption="false" />
														<s:fielderror>
									...
									<tr>
										<td>
											<table style="text-align: left; width: 100%">
												...
												<td>
													<s:textfield id="userName" name="sellerDTO.userName"
														maxlength="128" readonly="true"></s:textfield>
													<s:fielderror>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield id="sellerDTO.userEmail"
															name="sellerDTO.userEmail" />
														<s:fielderror>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textarea name="sellerDTO.sellerComment" cols="60"
															rows="5" maxlength="256"></s:textarea>
														<s:fielderror>
...
value="提 交" />
									...
									<td>
										<input type="button" class="bt" style="margin: 5px"
											onclick="window.location = '${ctx}/issuerSeller/inquery.action'"
											value="返 回" />
									</td>
								</tr>
							</table>
