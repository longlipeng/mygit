...
<body>
    ...
    <s:form id="customerForm" name="customerForm" action="" method="post">
        <s:hidden name="sellOrderCardListDTO.orderCardListId"></s:hidden>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="TableTitleFront">
                            <span class="TableTop">卡明细状态</span>
                        </td>
                    ...
                    <tr>
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    <td style="width: 120px; text-align: left;">将卡明细状态设置为：</td>
                                    <td>
                                        <s:radio list="#{3: '制卡成功', 4: '制卡失败'}" name="sellOrderCardListDTO.cardState"></s:radio>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <tr>
                    <td align="right">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <input type="button" class="bt" style="margin: 5px" onclick="submitForm('customerForm', '${ctx}/stockOrderAcceptAction!modifyCardState')" value="提 交"/>
                                </td>
                                <td>
