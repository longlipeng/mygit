	...
	<head>
		...
		<script type="text/javascript">
			...
			function selectSingleCardOperation() {
				...
				newForm.action='cardManageExt/selectSingleCardOperation?cardManagementQueryDTO.cardNo=' + t;
				newForm.submit();
			}
			var isDisplay = false;
			...
			function cardIsRltHolder(){
		       ...
		       newForm.action='cardManageExt/cardIsRltHolder.action';
      	       newForm.submit();
			}
...
<!-- 														</td> -->
<!-- 														<td> -->
<%-- 															<s:textfield name="cardManagementDTO.cardholderName" id="cardholderName" --%>
<%-- 																size="23"></s:textfield> --%>
<%-- 															<s:fielderror> --%>
<%-- 																<s:param> --%>
