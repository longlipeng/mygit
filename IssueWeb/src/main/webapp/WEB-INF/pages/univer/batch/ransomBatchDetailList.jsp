...
if(${flag}==1){
		TimeOperation(${order_id},
				...
				"${ctx}/batchfile/getRansomBatchDetail.action?order_id="+${order_id}+"&batch_id="+${batch_id},
				'处理中,请耐心等候...','5s');
	} else if (${flag}==2){
		location.href="${ctx}/batchfile/getRansomBatchDetail.action?order_id="+${order_id}+"&batch_id="+${batch_id};
	}
}
