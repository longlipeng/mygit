	...
	<head>
		...
		function submitForm(){
			...
			//if(productName == null || productName == ""){
				...
				//return;
			////}  
		    var obj1 = document.getElementById('entityId');
	        var entityObj = obj1.selectedIndex;
	        var entityIdObj = obj1.options[entityObj].value;
	        
	        if(entityIdObj == "" || entityIdObj == null){
					...
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="QueryBody">
							<s:form id="queryForm" name="queryForm"
								action="queryCardCurrentTimeStock/queryCardCurrentTimeStock.action?functionRoleId=3" method="post">
												...
												<tr>
													...
													<td>
										  				<s:select id="entityId" 
															list="entityList"
															name="cardCurrentTimeStockQueryDTO.issuerId" 
															listKey="entityId"
					...
					<td width="98%" height="10" align="center" valign="middle"
						...
						<div id="TableBody">
							<div id="listTable"
								...
								<s:form id="EditForm" name="EditForm" action="queryCardCurrentTimeStock/queryCardCurrentTimeStock.action?functionRoleId=3"
										method="post">
									<s:hidden name="cardCurrentTimeStockQueryDTO.productName" />
									<s:hidden name="cardCurrentTimeStockQueryDTO.issuerId" />
									<ec:table items="pageDataDTO.data"  var="map"  width="100%" 
										tableId="cardCurrentTimeStockQueryTable"
										form="EditForm" 
										action="queryCardCurrentTimeStock/queryCardCurrentTimeStock.action?functionRoleId=3"
