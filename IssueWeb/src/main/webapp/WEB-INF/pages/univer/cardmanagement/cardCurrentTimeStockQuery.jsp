					...
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="QueryBody">
							<s:form id="queryForm" name="queryForm"
								action="queryCardCurrentTimeStock/queryCardCurrentTimeStock.action" method="post">
					...
					<td width="98%" height="10" align="center" valign="middle"
						...
						<div id="TableBody">
							<div id="listTable"
								...
								<s:form id="EditForm" name="EditForm" action="queryCardCurrentTimeStock/queryCardCurrentTimeStock.action"
										method="post">
									<s:hidden name="cardCurrentTimeStockQueryDTO.productName" />
									<ec:table items="pageDataDTO.data"  var="map"  width="100%" 
										tableId="cardCurrentTimeStockQueryTable"
										form="EditForm" 
										action="queryCardCurrentTimeStock/queryCardCurrentTimeStock.action"
