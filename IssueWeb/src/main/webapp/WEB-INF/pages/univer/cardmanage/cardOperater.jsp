	...
	<head>
		...
		<script type="text/javascript">
			...
			function selectSingleCardOperation() {
				...
				newForm.action='cardManage/selectSingleCardOperation?cardManagementQueryDTO.cardNo=' + t;
				newForm.submit();
			}
			function changeCard(object){
				var kahao = document.getElementById('kahao').value;
				newForm.action='${ctx}/cardManage/cardQuerys.action?id='+kahao ;
				newForm.submit();
// 				alert(object.value);//选中的实际值
			...
			function query(){
				...
				newForm.action='${ctx}/cardManage/cardQuery.action';
				newForm.submit();
			}
			...
			function cardIsRltHolder(){
		       ...
		       newForm.action='cardManage/cardIsRltHolder.action';
      	       newForm.submit();
			}
			
			function getCardHolder(){
			newForm.action="${ctx}/cardholder/view.action?cardholderDTO.cardholderId=${cardManagementDTO.cardholderId}&cardManagementFlag='1'";
      	       newForm.submit();
			...
			function invalid() {
			    ...
			    newForm.action='${ctx}/cardManage/cardManageAction!invaild';
			    newForm.submit();
			}
			function closeWin(){
		    ...
		    function querycard(){
				...
				newForm.action='${ctx}/cardManage/cardQueryNo.action';
				newForm.submit();
			}
		    ...
		    function checkIdNo(){
		 	   var idNo=document.getElementById("agentrCertTypeNo").value
		   		var type=document.getElementById("agentrCertType").value
		   	
		     if(type=='00'){
		     	var temp= IdCardValidate(idNo);
		     	if(temp!=true){
		     		return;
		     	}
		   		}
							...
							<s:form id="newForm" name="newForm"
								...
								<table width="100%"
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="cardManagementDTO.transferOutCard"
															id="transferOutCard" size="23"></s:textfield>
														<s:fielderror>
															<s:param>
									...
									<tr>
										...
										<td>
											<div style="display: none" id="holderMobile">
												<table style="text-align: left; width: 100%">
													<tr>
														<td style="width: 160px; text-align: left;">
															手机号：
														...
														<td>
															<s:textfield name="cardManagementDTO.mobile" id="mobile"
																size="23"></s:textfield>
															<s:fielderror>
																<s:param>
										...
										<td>
											<div style="display: none" id="certTypeNo">
												<table style="text-align: left; width: 100%">
													<tr>
														<td style="width: 200px; text-align: left;">
															证件号码：
														...
														<td>
															<s:textfield name="cardManagementDTO.idNo" id="idNo"
																size="18"></s:textfield>
															<s:fielderror>
																<s:param>
											...
											<table style="text-align: centre; width: 100%">
												<tr>
													...
													<s:if test="#request.CardNos!=null">	<td style="width: 200px; text-align: left;">
														...
														<td> <select name="cardManagementDTO.transferOutCard" id="cardManagementDTO.transferOutCard" class="select"  onChange="changeCard(this)">
  		<option>请选择</option>
      <s:iterator value="#request.CardNos" id="cardNo">
      	<option>${cardNo }</option>
      </s:iterator>
									...
									<!-- 
											...
											<div  id="certTypeNo">
												<table style="text-align: left; width: 100%">
													<tr>
														...
														<td>
															<s:textfield name="applyAndBindCardDTO.idNo" id="idNo"
																size="23"></s:textfield>
															<s:fielderror>
																<s:param>
										...
										<td><table style="text-align: centre; width: 100%">
												<tr>
													<td>
													<s:if test="#request.CardNos!=null">	<td style="width: 200px; text-align: left;">
															请选择卡号：
      ...
      <s:iterator value="#request.CardNos" id="cardNo">
      	<option value="${cardNo}">${cardNo }</option>
										...
										<td style="padding-left:19px">
														<input  class='bt' type="button"
															style="float: left; margin: 0px 0px" onclick="querycard();"
												...
												<tr>
													<td>
														...
														<s:select list="#{'0':'否','1':'是'}"
															...
															id="cardManagementDTO.callBack" disabled="true" />
													</td>
												</tr>
											</table>
											</s:if>
														...
														<tr>
															...
															<td>
																<s:textfield name="cardManagementDTO.agentrCertTypeNo"
																	maxLength="18"  id="agentrCertTypeNo" onblur="checkIdNo()"/>
									...
									<tr>
										<td>
											<div id="buttonCRUD1"
												...
												valign="middle">
												<s:if test="cardManagementDTO.onymusState!=2">
												<s:if
													test="cardManagementDTO.cardNo==null||cardManagementDTO.cardNo==''||cardManagementDTO.active==3">
													...
													<s:if test="cardManagementDTO.invalidFlag==0">
													 <display:security urlId="4030116">
														<button class='bt' style="float: right; margin: 5px"
															disabled >
															作废
														</button>
												...
												<s:if
													test="cardManagementDTO.cardNo!=null&&cardManagementDTO.cardNo!=''">
													
													
								
													
													<s:if test="cardManagementDTO.active==1">
														<s:if test="cardManagementDTO.lock==1||cardManagementDTO.lock==2">
															<display:security urlId="3101514,4030114">
																<button class='bt' style="float: right; margin: 5px"
																	disabled>
																	安全信息设置
...
<!--															 解锁 -->
															<display:security urlId="3101501,4030101">
																<input type="button" class='bt' style="float: right; margin: 5px"
																	onclick="confirm('确定解锁吗？',function(){newForm.action='cardManage/nolockInit';newForm.submit();});" value="解锁"/>
															</display:security>
														</s:if>

														<s:if
															test="cardManagementDTO.lock==0&&cardManagementDTO.hang==0&&cardManagementDTO.off==0">
															<display:security urlId="3101514,4030114">
																<input type="button" class='bt' style="float: right; margin: 5px"
																	onclick="confirm('确定安全信息设置吗？',function(){newForm.action='cardManage/setCardSecurityInfoInit';newForm.submit();});" value="安全信息设置"/>
																	
															</display:security>
															<display:security urlId="3101513,4030113">
																<input type="button"  class='bt' style="float: right; margin: 5px"
																	onclick="confirm('确定密码重置吗？',function(){newForm.action='cardManage/passwordInit';newForm.submit();});" value="密码重置"/>
															...
															<display:security urlId="3101511,4030111">
																<input type="button"  class='bt' style="float: right; margin: 5px"
																	onclick="newForm.action='cardManage/cardTxnSelectInit';newForm.submit();" value="交易记录"/>
															</display:security>
															<display:security urlId="3101510,4030110">
																<input type="button" class='bt' style="float: right; margin: 5px"
																	onclick="confirm('确定赎回吗？',function(){newForm.action='cardManage/retrieveCardInit';newForm.submit();});" value="赎回"/>
															</display:security>
															<display:security urlId="3101508,4030108">
																<input type="button"  class='bt' style="float: right; margin: 5px"
																	onclick="confirm('确定转账吗？',function(){newForm.action='cardManage/transferAccountInit';newForm.submit();});" value="转账"/>
															</display:security>
															<display:security urlId="3101507,4030107">
																<input type="button"  class='bt' style="float: right; margin: 5px"
																	onclick="confirm('确定延期吗？',function(){newForm.action='cardManage/cardDelayInit';newForm.submit();});" value="延期"/>
															</display:security>
															<display:security urlId="3101506,4030106">
																<input type="button"  class='bt' style="float: right; margin: 5px"
																	onclick="confirm('确定充值吗？',function(){newForm.action='cardManage/rechargeInit';newForm.submit();});" value="充值"/>
																	
															</display:security>
															<display:security urlId="3101502,4030102">
																<input type="button"  class='bt' style="float: right; margin: 5px"
																	onclick="confirm('确定锁定吗？',function(){newForm.action='cardManage/lockInit';newForm.submit();});" value="锁定"/>
															</display:security>
															<display:security urlId="3101503,4030103">
																<input type="button"  class='bt' style="float: right; margin: 5px"
																	onclick="confirm('确定挂失吗？', function(){newForm.action='cardManage/hangInit';newForm.submit();});" value="挂失"/>
															</display:security>
														</s:if>
														...
														<s:if test="cardManagementDTO.hang==1&&cardManagementDTO.off!=1">
															<display:security urlId="3101514,4030114">
																<button class='bt' style="float: right; margin: 5px"
																	disabled>
																	安全信息设置
															...
															<!-- 充值 -->
																<display:security urlId="3101506,4030106">
																<input type="button"  class='bt' style="float: right; margin: 5px"
																	onclick="confirm('确定充值吗？',function(){newForm.action='cardManage/rechargeInit';newForm.submit();});" value="充值" disabled="disabled"/>
...
<%-- 															</display:security> --%>
															...
															<display:security urlId="3101504,4030104">
																<input type="button"  class='bt' style="float: right; margin: 5px"
																	onclick="confirm('确定解挂吗？',function(){newForm.action='cardManage/nohangInit';newForm.submit();});" value="解挂"/>
															</display:security>
														</s:if>
													</s:if>
													<s:if test="cardManagementDTO.active==0&&cardManagementDTO.stockState==3">
														<display:security urlId="3101514,4030114">
															<button class='bt' style="float: right; margin: 5px"
																disabled>
																安全信息设置
														...
														<display:security urlId="3101513,4030113">
															...
															<display:security urlId="3101515,4030115">
																<input type="button" class='bt' style="float: right; margin: 5px"
																	onclick="confirm('确定激活吗？',function(){newForm.action='cardManage/activeInit';newForm.submit();});" value="激活"/>
															</display:security>
															<s:if test="cardManagementDTO.invalidFlag==0">
															 <display:security urlId="4030116">											
																<input type="button"  class='bt' style="float: right; margin: 5px"
																	onclick="return confirmInvalid();" value="作废"/>
														</display:security>
														</s:if>
													</s:if>
									...
									<s:if test="cardManagementDTO.onymusState==2&&cardManagementDTO.active==1&&cardManagementDTO.off==0">
															<display:security urlId="3101512,4030112">
																<input type="button"  class='bt' style="float: right; margin: 5px"
																	onclick="selectSingleCardOperation();" value="业务记录"/>
															</display:security>
									...
									<s:if test="cardManagementDTO.onymusState==2&&cardManagementDTO.active==0">
													<display:security urlId="3101512,4030112">
														<button class='bt' style="float: right; margin: 5px"
															disabled>
															业务记录
									...
									<s:if test="cardManagementDTO.onymusState==2&&cardManagementDTO.active==1&&cardManagementDTO.off==1">
														<display:security urlId="3101512,4030112">
																<input type="button"  class='bt' style="float: right; margin: 5px"
																	onclick="selectSingleCardOperation();" value="业务记录"/>
															</display:security>
