...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
					...
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="serviceTable">
							<s:form id="newForm" name="newForm"
								action="cardManage/updateCardSecurity" method="post">
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="cardManagementDTO.posSingleAmount" />元
														<s:fielderror>
															<s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="cardManagementDTO.posDailyAmount" />元
														<s:fielderror>
															<s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="cardManagementDTO.webSingleAmount" />元
														<s:fielderror>
															<s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="cardManagementDTO.webDailyAmount" />元
														<s:fielderror>
															<s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="cardManagementDTO.withoutPinAmount" />元
														<s:fielderror>
															<s:param>
		...
		<div id="btnDiv" style="text-align: right; width: 100%">
			<button class='bt'type="button" style="float: right; margin: 5px" onclick="newForm.action='cardManage/viewCardSecurity.action';newForm.submit();">
				返 回
			</button>
			<div style="clear: both"></div>
		</div>
