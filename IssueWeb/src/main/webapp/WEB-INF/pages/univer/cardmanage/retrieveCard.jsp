	...
	<head>
		...
		<script type="text/javascript">
			...
			function getMoney(){
				...
				money=parseInt(balance)-parseInt(redemptionFee)+parseInt(costPrice);
			...
			check();
			 var type=document.getElementsByName("type");
		        ...
		        if(value==0){
		        	errorDisplay("请选择一种赎回方式！");
		        }else{
		        	document.newForm.action='cardManage/redemptionCard?cardManagementDTO.flag='+value;
		        	newForm.submit();
		        }
			...
			var reCardNo=document.getElementById("reCardNo").value;
			var intPatrn=/^[0-9]{19}$/;
			if(cardNo!=null && cardNo.trim()!=""){
				if(!intPatrn.exec(cardNo)){
					errorDisplay("请输入卡号");
					return;
				}
				if(cardNo!=reCardNo){
					errorDisplay("卡号和重复输入卡号必须一致");
					return;
				}
			}
			}
	...
	<body onload="a()">
									...
									<tr>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 110px; text-align: right;">
														<span class="no-empty">*</span>重复输入卡号：
													</td>
													<td>
														<s:textfield name="reCardNo" id="reCardNo"/>
														<s:fielderror>
															<s:param>
																cardNo
															</s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="cardManagementDTO.redemptionFee" id="redemptionFee" size="23" value="0" onchange="getMoney();"></s:textfield> 元
														<s:fielderror>
															<s:param>
																cardManagementDTO.redemptionFee
															</s:param>
														</s:fielderror>
														</td>
														<td>
		...
		<div id="btnDiv" style="text-align: right; width: 100%">
			...
			<!-- <input type="radio" name="type" value="1"/>
				<span style="cursor:default">入库</span> -->
				<input  type="radio"   checked="true"  name="type" value="2"  />
				<span style="cursor:default">销户</span>			
