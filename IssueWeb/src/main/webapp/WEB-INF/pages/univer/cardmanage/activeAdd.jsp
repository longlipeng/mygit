					...
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="serviceTable">
							<s:form id="newForm" name="newForm"
								action="cardManage/activeCard.action" method="post">
							...
							<s:hidden name="cardManagementDTO.agentrName" />
		                      ...
		                      <s:hidden name="cardManagementDTO.endDate" />	
		                        <s:hidden name="cardManagementDTO.owner" />	
		                         <s:hidden name="cardManagementDTO.stockState" />
		                         <s:hidden name="cardManagementDTO.adjustAmount"></s:hidden>					
										...
										<%-- <td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="cardManagementDTO.serviceFee" maxlength="3"/>元
														<s:fielderror>
															<s:param>
