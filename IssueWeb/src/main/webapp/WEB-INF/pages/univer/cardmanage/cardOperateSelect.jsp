...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function query() {
		...
		queryForm.action = '${ctx}/cardManage/selectCardOperation.action';
		queryForm.submit();
	}
</script>
	</head>
	<body>
		...
		<div id="list"
			...
			<div id="listTable"
				style="background-color: #FBFEFF;border-style: solid none none; border-width: 1px; border-color: #B9B9B9;">
					<ec:table items="pageDataDTO.data" var="map" width="100%"
						form="queryForm"
						action="${ctx}/cardManage/selectCardOperation.action"
			...
			<%-- <form id="newForm" name="newForm" action="cardManage/cardTxnSelect.action" method="post">
			<input type="hidden" name="cardManagementDTO.transferOutCard" value="${cardManagementQueryDTO.cardNo}"  />
