...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function presentationDetail(){
        ...
        document.getElementById('__format').value="pdf";
       	document.getElementById('settleId').value=n;
        mchntSettleForm.action = '${ctx}/merchantSettle/querySettleDetail.action?settleQueryDTO.settleId='+n;
	...
	function payment(){
        ...
        document.getElementById('__report').value="/report/rpt_red_payment_request.rptdesign";
        document.getElementById('__format').value="pdf";
       	document.getElementById('settleId').value=n;
        queryForm.submit();
	}
    ...
    function querySettle() {
        ...
        mchntSettleForm.action = '${ctx}/merchantSettle/query.action?state=5';
        mchntSettleForm.submit();
    }
    ...
    function confirmPay() {
        ...
        mchntSettleForm.action = '${ctx}/merchantSettle/settlePaymentConfirm.action';
        mchntSettleForm.submit();
    }
    function viewDetail(settleId){
    	window.location='${ctx}/merchantSettle/querySettleDetail.action?settleQueryDTO.settleId=' + settleId;
    }
	</script>
	</head>
	<body>
					...
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="QueryBody">
							<s:form id="mchntSettleForm" name="mchntSettleForm"
								action="merchantSettle/inquiryMerchantSettle" method="post">
								 ...
								 <!--  <tr>
					                  ...
					                  <tr>
										...
										<td width="160">
											...
											<input type="text" name="settleQueryDTO.settleStartDate" onclick="dateClick(this)" class="Wdate" value="${settleQueryDTO.settleStartDate}"/>
										...
										<td width="160">
											...
											<input type="text" name="settleQueryDTO.settleEndDate" onclick="dateClick(this)" class="Wdate" value="${settleQueryDTO.settleEndDate}"/>
										</td>
										</tr>
				                    <tr>
					...
					<td width="98%" height="10" align="center" valign="middle"
						...
						<div id="TableBody">
							...
							<ec:table items="pageDataDTO.data" var="map" width="100%"
								...
								action="${ctx}/merchantSettle/query.action?state=5"
								...
								<ec:row onclick="">
									<ec:column property="null" alias="settleIdList" title="选择" width="5%" sortable="false" headerCell="selectAll" viewsAllowed="html">
										...
										<!-- <input type="hidden" name="mchntGroupIdList" value="${map.merchantGrpId}"/>-->
									</ec:column>
									...
									<ec:column property="settleObject2Name" title="商户名称" width="15%"/>
									
									<ec:column property="settleStartDate" format="yyyy-MM-dd" title="结算起始日期" width="10%"/>
