					...
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="serviceTable">
							<s:form id="newForm" name="newForm"
								action="terParameter/updatePrm" method="post">
								...
								<table width="100%" style="table-layout: fixed;">
									<tr>
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="posParameterDTO.prmVersion" readonly="true"></s:textfield>
														<s:fielderror>
															<s:param>
										...
										<s:if test="posParameterDTO.prmType=='10002'">
									<%-- 	<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 110px; text-align: right;">
													...
													<td>
														<s:textfield name="posParameterDTO.cardLength" ></s:textfield>
														<s:fielderror>
															<s:param>
																posParameterDTO.cardLength
															</s:param>
														</s:fielderror>
													</td>
												</tr>
									...
									<tr>
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													<td style="width: 110px; text-align: right;">
														<span class="no-empty">*</span>参数标识：
													</td>
													<td>
														<s:textfield name="posParameterDTO.prmId" readonly="true"></s:textfield>
														<s:fielderror>
															<s:param>
																posParameterDTO.prmId
															</s:param>
														</s:fielderror>
													</td>
												</tr>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:hidden name="posParameterDTO.prmName"/>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:hidden name="posParameterDTO.prmType"/>
														<dl:dictList displayName="posParameterDTO.prmType"
									...
									<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
													<c:if test="${posParameterDTO.prmType eq 10002}">
														<s:textfield name="posParameterDTO.prmVal" maxLength="8" />
														</c:if>
											     <c:if test="${posParameterDTO.prmType ne 10002}">
														<s:textfield name="posParameterDTO.prmVal"/>
													</c:if>	
														<s:fielderror>
															<s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textarea name="posParameterDTO.prmDesc" rows="5" cols="50"/>			
														<s:fielderror>
															<s:param>
