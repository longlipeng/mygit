...
.x-tree-node-icon {
	display: none;
		...
		function sub(){
				document.newForm.action="merchantManagement/modifWebPassword.action";
	...
	<body>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="merchantDTO.entityId" readonly="true"></s:textfield>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="merchantDTO.merchantName" readonly="true"></s:textfield>
													</td>
												</tr>
											</table>
										</td>
		...
		<div id="btnDiv" style="text-align: right; width: 100%">
			<button class='bt' type="button"
				...
				onclick="window.location='merchantManagement/inquiry'">
				返 回
			</button>
