					...
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="QueryBody">
						  <s:form id="queryForm" name="queryForm"
								action="merchantManagement/chooseExternalMchnt" method="post">
			                <table>
									...
									<tr height="35">
										...
										<td width="160">
											<s:hidden name="merchantQueryDTO.entityId" id='entityId' />
					...
					<td width="98%" height="10" align="center" valign="middle"
						...
						<s:form id="merchantForm" name="EditForm"
							...
							<ec:table items="pageDataDTO.data" var="map" width="100%"
								form="EditForm"
								action="${ctx}/merchantManagement/chooseExternalMchnt"
								...
								<ec:row onclick="">
									<ec:column property="null" alias="choose" title="选择" width="10%" sortable="false">
										<input type="radio" name="entityId" value="${map.entityId}" />
									</ec:column>
									...
									<tr>
										<td>
											<div id="buttonCRUD"
												...
												valign="middle">
												<input type="button" class="bt" style="margin: 5px" onclick="chooseMchnt()" value="确定"/>
