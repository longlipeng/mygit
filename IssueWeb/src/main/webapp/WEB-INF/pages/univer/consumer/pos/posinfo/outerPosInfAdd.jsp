			...
			<table width="98%" border="0" cellpadding="0" cellspacing="1"
				...
				<tr>
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="serviceTable">
							<s:form id="newForm" name="newForm" action="insertOuterPosInf.action"
								method="post">
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
													<s:hidden id="mchntEntityId" name="mchntEntityId"></s:hidden>
												...
												<tr>
													...
													<td>
														<s:textfield name="outerPosInfoDTO.shopName"
															id="outerPosInfoDTO.shopName" readonly="true" />
														<s:fielderror>
															<s:param>
												...
												<tr>
													...
													<td>
														<s:textfield name="outerPosInfoDTO.termBrandId"
															id="outerPosInfoDTO.termBrandId" cssClass="watch"
												...
												<tr>
													...
													<td>
														<s:textfield name="outerPosInfoDTO.termBrandName"
															id="outerPosInfoDTO.termBrandName" />
														<s:fielderror>
															<s:param>
