	...
	<body>
					...
					<td width="100%" height="10" align="left" valign="top"
						...
						<table width="100%" height="20" border="0" cellpadding="0"
							...
							<tr>
								<td class="TableTitleFront" onclick="displayServiceTable();"
									...
									<span class="TableTop">终端厂商编辑</span>
								</td>
						...
						<div id="serviceTable">
							<s:form id="editForm" name="editForm"
								 action="updatePosBrandInf"  method="post">
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="posBrandInfDTO.termBrandId" readonly="true"></s:textfield>
														<s:fielderror>
															<s:param>
																posBrandInfDTO.termBrandId
															</s:param>
														</s:fielderror>
													</td>
												</tr>
		...
		<div id="btnDiv" style="text-align: right; width: 100%">
			...
			<button class='bt' style="float: right; margin: 5px"
				onclick="this.disabled='disabled';editForm.submit();setTimeout(function (){ obj.removeAttribute('disabled');},'5000');">
				提 交
			</button>
