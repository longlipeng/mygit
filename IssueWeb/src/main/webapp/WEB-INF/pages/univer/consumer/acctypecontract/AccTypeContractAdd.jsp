...
function setForm() {
            var serviceId=document.getElementsByName("accTypeContractDTO.acctypeId")[0].value;
            if(serviceId.length==0){
            	alert("所有服务合同都添加完，不能再添加服务合同！");
				return false;
            }
			...
			<table width="98%" border="0" cellpadding="0" cellspacing="1"
				...
				<tr>
					<td width="100%" height="10" align="left" valign="top"
						...
						<s:hidden name="accTypeContractDTO.constractType" id="constractType"></s:hidden>
						...
						<div id="acctypeContractTable">
								<table width="100%" style="table-layout: fixed;">
									  ...
									  <td>
									    ...
									    <table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:select list="accTypeContractDTO.serviceDTOList" 
														name="accTypeContractDTO.acctypeId"
														listKey="serviceId" listValue="serviceId">
														</s:select>
									...
									<s:hidden name="accTypeContractDTO.contractBuyer"></s:hidden>
								</table>
					  </div>
					</td>
				</tr>
			...
			<table width="98%" border="0" cellpadding="0" cellspacing="1"
              ...
              <ec:row>
                <ec:column property="null" alias="ruleNoList" title="选择" width="10%" sortable="false" headerCell="selectAll" viewsAllowed="html">
                    ...
                    <c:set var="discCd" value="${feeRuleDTO.discCd}" scope="page"/>
                </ec:column>
