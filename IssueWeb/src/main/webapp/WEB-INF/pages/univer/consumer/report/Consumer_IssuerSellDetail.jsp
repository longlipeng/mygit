...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	  ...
	  function choiceSeller() {
    	var sellerDTO=window.showModalDialog('${ctx}/ireport/issuerChoose.action', '_blank', 'center:yes;dialogHeight:400px;dialogWidth:600px;resizable:no');
         if (sellerDTO != null) {
	...
	<body>
		...
		<s:form id="queryForm" name="queryForm"
			action="/ireport/queryIssuerDetail!viewReport.action" method="post">
				                <s:hidden name="comsumerIssuerDetailDTO.reportName"></s:hidden>
								<s:hidden name="comsumerIssuerDetailDTO.reportType"></s:hidden>
								<s:hidden name="comsumerIssuerDetailDTO.consumerId"></s:hidden>
								<s:hidden name="comsumerIssuerDetailDTO.consumerName"></s:hidden>
								<s:hidden name="comsumerIssuerDetailDTO.reportFileName"></s:hidden>
			<div id="base"
							...
							<td>
								<table style="text-align: right; width: 100%">
									<tr>
										...
										<td align="left">
											<s:textfield name="comsumerIssuerDetailDTO.startDate" id="startDate"
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:textfield name="comsumerIssuerDetailDTO.endDate" id="endDate"
