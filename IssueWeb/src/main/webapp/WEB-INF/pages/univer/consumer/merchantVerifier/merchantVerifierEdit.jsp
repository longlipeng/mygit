...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    function operateDetail(operater,list,url, inqueryUrl) {
        ...
        if (operater == 'delete') {
			...
			window.confirm("确认要删除吗?",deleteBank);
			return ;	
...
*/
	...
	<body onload="InitPage()">
		...
		<s:form id="newForm" name="newForm" action="merchantVerifier/update">
											...
											<td>
												<table style="text-align: left; width: 100%">
													<tr>
														...
														<td>
															<s:textfield name="merchantDTO.entityId" id="entityId"
													...
													<tr>
														...
														<td>
															<s:textfield name="merchantDTO.merchantCode"
																id="merchantDTO.merchantCode" readonly="true" />
													...
													<tr>
														...
														<td>
															<s:textfield name="merchantDTO.merchantRealityName"
																id="merchantDTO.merchantRealityName" />
															<s:fielderror>
																<s:param>
											...
											<td>
												<table style="text-align: left; width: 100%">
													<tr>
														...
														<td>
															<s:textfield name="merchantDTO.salesmanId"
																id="salesmanId" />
															<s:fielderror>
																<s:param>
													...
													<tr>
														...
														<td>
															<edl:entityDictList
																...
																dictType="185" tagType="2" defaultOption="false" />
															<s:fielderror>
																<s:param>
												...
												<tr>
													...
													<td>
														<edl:entityDictList
															...
															dictType="187" tagType="2" defaultOption="false" />
														<s:fielderror>
															<s:param>
										...
										<td>
											<table width="100%" style="table-layout: fixed;">
												<tr>
													...
													<td>
														<s:textfield name="merchantDTO.legalPersonIdno"></s:textfield>
														<s:fielderror>
															<s:param>
					...
					<tr>
						<td width="100%" height="10" align="left" valign="top"
							...
							<table width="100%" height="20" border="0" cellpadding="0"
								...
								<tr>
									<td class="TableTitleFront"
										onclick="displayTable('paraTable');" style="cursor: pointer;">
												...
												<tr>
													...
													<td>
														<s:radio name="merchantDTO.commissionFee"
															id="merchantDTO.commissionFee" list="#{'1':'是','0':'否'}"
															disabled="sensitiveData"></s:radio>
													</td>
												</tr>
											</table>
										</td>
												...
												<tr>
													...
													<td>
														<s:radio name="merchantDTO.reimburseWithoutCheck"
															...
															list="#{'1':'是','0':'否'}" disabled="sensitiveData"></s:radio>
													</td>
												</tr>
											</table>
										</td>
													...
													<td>
														...
														<s:else>
															<edl:entityDictList
																displayName="merchantDTO.reimbursementType"
																dictValue="${merchantDTO.reimbursementType}"
																dictType="106" tagType="2" defaultOption="false" />
														</s:else>
													</td>
												</tr>
											</table>
		...
		<div id="btnDiv" style="text-align: right; width: 100%">
			<button class='bt' style="float: right; margin: 5px 10px"
				onclick="newForm.action='merchantVerifier/inquiry';newForm.submit();">
				返 回
			</button>
										...
										<tr>
											<td>
												<input type="button" class="btn"
													...
													onclick="operateDetail('add','chooseBankId','${ctx}/merchantVerifier/addBank.action?entityId=${merchantDTO.entityId}'+'&'+'actionName=merchantVerifier/insertBanik', '${ctx}/merchantVerifier/edit.action')"
													value="添加" />
											</td> 
											<td>
												<input type="button" class="btn"
													style="width: 50px; height: 20px; margin: 2px 5px; background: url(${ctx}/images/icon/add.gif) no-repeat; text-align: right"
													onclick="operateDetail('edit','chooseBankId','${ctx}/merchantVerifier/editBank.action?'+getParam('chooseBankId')+'&'+'merchantDTO.entityId=${merchantDTO.entityId}'+'&'+'actionName=merchantManagement/editBanik', '${ctx}/merchantVerifier/edit.action')"
													value="编辑" />
											</td> 
											<td> 
												<input type="button" class="btn"
													style="width: 50px; height: 20px; margin: 2px 5px; background: url(${ctx}/images/icon/delete.gif) no-repeat; text-align: right"
													onclick="operateDetail('delete','chooseBankId','${ctx}/merchantVerifier/deleteBank.action?'+getParam('chooseBankId')+'&'+'merchantDTO.entityId=${merchantDTO.entityId}', '${ctx}/merchantVerifier/edit.action')"
													value="删除" />
											</td>
										</tr>
									</table>
...
<%--						</table>--%>
<%--						<div id="contactTable">--%>
<%--							<s:form id="contactForm" name="contactForm" action=""--%>
<%--								method="post">--%>
...
<%--								<input type="button" class="btn"--%>
<%--									style="width: 50px; height: 20px; margin: 2px 5px; background: url(${ctx}/images/icon/add.gif) no-repeat; text-align: right"--%>
<%--									onclick="operateDetail('add','contactIdList','merchantVerifier/addContact?merchantDTO.entityId=${merchantDTO.entityId}'+'&'+'actionName=merchantManagement/insertContact', '${ctx}/merchantVerifier/edit.action')"--%>
<%--									value="添加" />--%>
<%--							</td>--%>
<%--							<td>--%>
<%--								<input type="button" class="btn"--%>
<%--									style="width: 50px; height: 20px; margin: 2px 5px; background: url(${ctx}/images/icon/modify.gif) no-repeat; text-align: right"--%>
<%--									onclick="operateDetail('edit','contactIdList','merchantVerifier/editContact?'+getParam('contactIdList')+'&'+'merchantDTO.entityId=${merchantDTO.entityId}'+'&'+'actionName=merchantManagement/updateContact', '${ctx}/merchantVerifier/edit.action')"--%>
<%--									value="编辑" />--%>
<%--							</td>--%>
<%--							<td>--%>
<%--								<input type="button" class="btn"--%>
<%--									style="width: 50px; height: 20px; margin: 2px 5px; background: url(${ctx}/images/icon/delete.gif) no-repeat; text-align: right"--%>
<%--									onclick="operateDetail('delete','contactIdList','merchantVerifier/deleteContact?'+getParam('contactIdList')+'&'+'merchantDTO.entityId=${merchantDTO.entityId}', '${ctx}/merchantVerifier/edit.action')"--%>
<%--									value="删除" />--%>
<%--							</td>--%>
<%--						</tr>--%>
<%--                    </table>--%>
