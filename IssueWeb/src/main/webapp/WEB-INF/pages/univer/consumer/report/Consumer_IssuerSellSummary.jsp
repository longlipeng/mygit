...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<s:form id="queryForm" name="queryForm"
			action="/ireport/queryIssuerSellSummary!viewReport.action" method="post">
				                <s:hidden name="issuerSellSummaryDTO.reportName"></s:hidden>
								<s:hidden name="issuerSellSummaryDTO.reportType"></s:hidden>
								<s:hidden name="issuerSellSummaryDTO.reportFileName"></s:hidden>
			<div id="base"
							...
							<td>
								<table style="text-align: right; width: 100%">
									<tr>
										...
										<td align="left">
											<s:textfield 
												name="issuerSellSummaryDTO.issuerId" cssClass="watch" id="issuerId"
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:textfield
												name="issuerSellSummaryDTO.issuerName" readonly="true" id="issuerName"
												cssClass="readonly" />
										</td>
									</tr>
								</table>
							...
							<td>
								<table style="text-align: right; width: 100%">
									<tr>
										...
										<td align="left">
											<s:textfield name="issuerSellSummaryDTO.startDate" id="startDate"
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:textfield name="issuerSellSummaryDTO.endDate" id="endDate"
