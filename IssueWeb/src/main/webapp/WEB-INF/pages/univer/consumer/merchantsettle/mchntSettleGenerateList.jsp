...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    function querySettle() {
        ...
        mchntSettleForm.action = '${ctx}/merchantSettle/query.action?state=2';
        mchntSettleForm.submit();
    }
    ...
    function confirm() {
        ...
        mchntSettleForm.action = '${ctx}/merchantSettle/queryDrafeSettle.action?settleQueryDTO.settleState=4';
        mchntSettleForm.submit();
    }
					...
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="QueryBody">
							<s:form id="mchntSettleForm" name="mchntSettleForm"
								action="merchantSettle/query.action?state=2" method="post">
					...
					<td width="98%" height="10" align="center" valign="middle"
						...
						<div id="TableBody">
							...
							<ec:table items="pageDataDTO.data" var="map" width="100%"
								...
								action="${ctx}/merchantSettle/query.action?state=2"
								...
								<ec:row onclick="">
                                    ...
                                    <ec:column property="settleState" title="状态" width="8%" cell="dictInfo" alias="214">
                                    </ec:column>             						
								</ec:row>
							</ec:table>
