										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="posParameterDTO.prmVersion" id="prmVersion" onblur="commPrm();"></s:textfield>
														<s:fielderror>
															<s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														IC参数
														<s:hidden name="posParameterDTO.prmType" value="10003" id="prmType"/>									
													</td>
												</tr>
											</table>
										</td>																														
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>																																																																																	
														<s:select list="#{'':'请选择','9F06':'AID','9F08':'应用版本号','DF01':'ASI','DF11':'TAC-缺省','DF12':'TAC-联机','DF13':'TAC-拒绝','DF18':'终端联机PIN支持'}"  name="posParameterDTO.prmName"/>				
														<s:fielderror>
															<s:param>
