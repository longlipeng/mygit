...
<html xmlns="http://www.w3.org/1999/xhtml">
	  ...
	  function choiceSeller() {
    	var sellerDTO=window.showModalDialog('${ctx}/ireport/merchantChoose.action', '_blank', 'center:yes;dialogHeight:400px;dialogWidth:600px;resizable:no');
         if (sellerDTO != null) {
            ...
            document.getElementById('merchantId').value = string[0];
	...
	<body>
		...
		<s:form id="queryForm" name="queryForm"
			action="/ireport/queryCalculateWithMerchant!viewReport.action" method="post">
				                <s:hidden name="calculateWithMerchantDTO.reportName"></s:hidden>
								<s:hidden name="calculateWithMerchantDTO.reportType"></s:hidden>
								<s:hidden name="calculateWithMerchantDTO.issuerId"></s:hidden>
								<s:hidden name="calculateWithMerchantDTO.issuerName"></s:hidden>
								<s:hidden name="calculateWithMerchantDTO.reportFileName"></s:hidden>
			<div id="base"
							...
							<td>
								<table style="text-align: right; width: 100%">
									<tr>
										...
										<td align="left">
											<s:textfield name="calculateWithMerchantDTO.startDate" id="startDate"
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:textfield name="calculateWithMerchantDTO.endDate" id="endDate"
