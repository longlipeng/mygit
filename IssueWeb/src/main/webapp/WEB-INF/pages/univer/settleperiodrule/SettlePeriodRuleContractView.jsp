										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:select list="#{'1':'固定周期','0':'非固定周期','2':'混合周期'}"
                ...
                <tr>
                    <td align="right">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <input type="button" class="bt" style="margin: 5px" onclick="settleRuleForm.action='sellerConstract/settleRuleChoice.action';settleRuleForm.submit();" value="返 回"/>
                                </td>
                            </tr>
                        </table>
                    </td>
