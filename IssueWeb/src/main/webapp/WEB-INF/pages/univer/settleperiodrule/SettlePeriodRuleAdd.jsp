...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    function addRule(){debugger;
    	...
    	maskDocAll();
        settleRuleForm.action='${ctx}/settleRule/insert.action';
      ...
      if(ruleType=='1'){
    	...
    	if(period!=null || period!="" || period!=0){
    		for(var i=0;i<period;i++){          
    		 ...
    		 if(appointPeriodValue!=null && appointPeriodValue!=''){
    		 		appointPeriod.get(0).selectedIndex=parseInt(appointPeriodValue)+1;
			        //appointPeriod.options[parseInt(appointPeriodValue)+1].selected=true;
		      } 
    	}
    	 appointDay.find("option[value!='']").remove();
    	if(periodType=="D"){
		 ...
		 if(appointDayValue!=null && appointDayValue!=''){
		           appointPeriod.get(0).selectedIndex=parseInt(appointDayValue)+1;
			         //appointDay.options[parseInt(appointDayValue)+1].selected=true;
		    } 
    	}else if(ruleType=='0'){
    	...
    	if(periodType=="D"){
		 ...
		 if(appointDayValue!=null && appointDayValue!=''){
		 alert(parseInt(appointDayValue)+1);
		             appointPeriod.get(0).selectedIndex=parseInt(appointDayValue)+1;
			         //appointDay.options[parseInt(appointDayValue)+1].selected=true;
		    } 
    	}   	
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
										               <s:select list="#{'D':'按天数','W':'按周数','M':'按月数'}"
								      	...
								      	<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="settlePeriodRuleDTO.period" size="11"
												...
												<tr>
													...
													<td>
														<s:select list="#{'':'--请选择--'}" name="settlePeriodRuleDTO.appointPeriod" 
															id="settlePeriodRuleDTO.appointPeriod"/>
                                                       <s:fielderror>
															<s:param>
