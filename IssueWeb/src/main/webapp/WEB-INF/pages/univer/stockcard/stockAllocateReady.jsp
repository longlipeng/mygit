...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function readyList() {
				...
				stockForm.action='${ctx}/stockAllocateAction!cardArrayReady.action';
				stockForm.submit();
			}

			function cardSegmentReady(){
				...
				stockForm.action='${ctx}/stockAllocateAction!cardSegmentReady';
			...
			function queryStock(){
				stockForm.action='${ctx}/stockAllocateAction!cardReady';
				stockForm.submit();
			}
	...
	<body onload="cardNoInit();">
		...
		<s:form id="stockForm" name="stockForm" action="" method="post">
			<s:hidden name="orderReadyDTO.orderId" id="orderId"/>
			<s:hidden name="orderReadyDTO.firstEntityId"/>
			<s:hidden name="orderReadyDTO.processEntityId"/>
			<s:hidden name="orderReadyDTO.realAmount"/>
			<s:hidden name="orderReadyDTO.loginUserId"/>
				...
				<tr>
					<td width="98%" height="10" align="center" valign="middle"
						...
						<ec:table items="pageDataDTO.data" var="map" width="100%" form="stockForm"
							action="${ctx}/stockAllocateAction!cardReady"
								...
								<tr>
									<td>
										<div id="buttonCRUD"
											...
											<button class='btn' style="float: right; margin: 7px" onclick="cardSegmentReady();">
												全部准备
											</button>
