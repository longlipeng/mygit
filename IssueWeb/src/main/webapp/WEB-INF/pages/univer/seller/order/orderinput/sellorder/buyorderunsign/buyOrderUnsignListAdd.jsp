...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body <s:if test="sellOrderListDTO.cardLayoutId != null">onload="init();"</s:if>>
						...
						<td width="100%" height="10" align="left" valign="top"
							...
							<div id="serviceTable">
								<s:form id="newForm" name="newForm"
									action="buyOrderUnSignAction!insertOrderList" method="post">
									 ...
									 <td align="right" width="15%" nowrap="nowrap">
											...
											<td width="35%" align="left" nowrap="nowrap">
												<s:textfield name="sellOrderListDTO.cardIssueFee"
													id="sellOrderListDTO.cardIssueFee" readonly="true" />
												<s:fielderror>
													<s:param>
										...
										<tr>
											...
											<td width="35%" align="left" nowrap="nowrap">
												<s:textfield name="sellOrderListDTO.packageFee"
													id="sellOrderListDTO.packageFee"  readonly="true" cssClass="lg_text_gray"/>
												<s:fielderror>
													<s:param>
