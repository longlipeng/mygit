...
<br/>
<br/>
<div  align="center"><font style="line-height:30px;font-size=22px;font-weight:bold;" >${sellOrderDTO.processEntityName}客户充值凭证   </font> 打印日期:${sellOrderDTO.printDate}</div>
<div align="center"><table width="80%" border="1px solid;">
	...
	<tr>
		...
		<td>
			...
			充值总金额(元):${sellOrderDTO.newCardTotalAmt}
			<br/>
			服务费率:${sellOrderDTO.serviceFee}%&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			卡数量(张):${sellOrderDTO.cardQuantity}
		</td>
	</tr>
	<tr>
		<td class="title">
		...
		<td>
			<table width="100%">
				<tr>
					<td>
						<s:iterator value="sellOrderDTO.cardNoSectionDTOs" id="cardSection">
							充值${cardSection.faceValue }元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${cardSection.cardQuantity}张
							<br/>
							<s:iterator value="#cardSection.cardNoSection" id="cardNo">
