                            ...
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td><s:textfield id="entityId" name="cardholderDTO.entityId" cssClass="watch" readonly="true" onclick="choiceCustomer()"/>
                                        ...
                                        <input type="hidden" name="cardholderDTO.mailingAddress" id="mailingAddress" ></input>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <s:select disabled="true" list="#{'':''}" name="cardholderDTO.departmentId" id="department"></s:select>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <tr>
                    <td align="right">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
<!--                                <td>-->
<!--                                    <input type="button" class="bt" style="margin: 5px" onclick="submitAjaxForm('cardholderForm', '${ctx}/cardholder/checkFile.action')" value="检 查"/>-->
<!--                                </td>-->
                                <td>
                                    <input type="button" class="bt" style="margin: 5px" onclick="document.forms['cardholderForm'].target = '_self'; submitForm('cardholderForm', '${ctx}/cardholder/importFile.action')" value="导 入"/>
                                </td>
                                <td>
