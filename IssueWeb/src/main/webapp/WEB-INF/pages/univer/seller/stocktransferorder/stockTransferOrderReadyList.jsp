...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<script type="text/javascript">
			...
			function submitForm(method) {
				...
				if (method=="edit" && !flag) {
					...
					EditForm.action = "stockTransferOrderInputAction!stockTransferOrderEdit";
		            EditForm.submit();
					return;
				}
			...
			function ready(orderId){
				 EditForm.orderId.value = orderId;
				 document.EditForm.action = "stockTransferOrderReadyAction!ready";
			...
			function sendBack(){
				...
				if (!flag) {
					EditForm.orderId.value = orderId;
				 	document.EditForm.action = "stockTransferOrderReadyAction!sendBackOrder";
					document.EditForm.submit();
					return;
				}
				errorDisplay("请选择一条记录！");
	...
	<body>
		...
		<div class="TitleHref">
			<span>调拨订单管理-->库存调拨订单出库</span>
		</div>
		
		<div id="ContainBox">
		<s:form id="queryForm" name="queryForm" action="stockTransferOrderReadyAction!list">
				...
				<tr>
					<td width="98%" height="10" align="center" valign="middle"
						...
						<ec:table items="stockTransferOrders" var="map" width="100%" form="queryForm"
							action="${ctx}/stockTransferOrderReadyAction!list"
