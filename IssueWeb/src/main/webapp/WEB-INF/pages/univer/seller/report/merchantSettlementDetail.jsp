...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<s:form id="queryForm" name="queryForm"
			action="/ireport/queryMerchantSettlementDetail!viewReport.action"  method="post">
            <s:hidden name="merchantSettlementDetailDTO.reportName"></s:hidden>
			<s:hidden name="merchantSettlementDetailDTO.reportType"></s:hidden>
			<s:hidden name="merchantSettlementDetailDTO.issuerId"></s:hidden>
			<s:hidden name="merchantSettlementDetailDTO.issuerName"></s:hidden>
			<s:hidden name="merchantSettlementDetailDTO.reportFileName"></s:hidden>	
			<div id="base"
							...
							<td>
								<table style="text-align: right; width: 100%">
									<tr>
										...
										<td>
											<s:textfield name="merchantSettlementDetailDTO.startDate" id="startDate"
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:textfield name="merchantSettlementDetailDTO.endDate" id="endDate"
							...
							<td>
								<table style="text-align: right; width: 100%">
									<tr>
										...
										<td align="left">
											<s:textfield name="merchantSettlementDetailDTO.merchantNo" id="merchantNo"
												 size="20" >
											</s:textfield>
										</td>
									</tr>
