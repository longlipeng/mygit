							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:select list="#{2:'',1:'是',0:'否'}" name="customerDTO.survey" disabled="true"></s:select>
										</td>
									</tr>
								</table>
							</td>
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:select list="#{2:'',1:'是',0:'否'}"
												name="customerDTO.creditInformation" disabled="true"></s:select>
										</td>
									</tr>
								</table>
							</td>
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:select list="#{2:'',1:'是',0:'否'}"
												name="customerDTO.badnessInspect" disabled="true"></s:select>
										</td>
									</tr>
								</table>
							</td>
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<edl:entityDictList displayName="customerDTO.creditStatus" props="disabled=\"true\""
