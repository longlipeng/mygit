...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function submitForm(){
		/* var sellerId = document.getElementById('customerId').value;
	...
	<body>
		...
		<s:form id="queryForm" name="queryForm"
			action="/ireport/querySellCardAction!viewReport.action" method="post">
									...
									<tr>
										...
										<td>
											<s:textfield name="sellerSellCardDetailDTO.customerId" id="customerId"
												 size="20" onchange="changeConsumer()" cssClass="watch" onclick="chooseConsumer()">
											</s:textfield>
															<s:fielderror>
							...
							<td>
								<table style="text-align: left; width: 55%">
									<tr>
										...
										<td>
											<s:textfield
												name="sellerSellCardDetailDTO.customerName" clientidmode="Static"  readonly="true" id="customerName"/>
										</td>
									</tr>
								</table>
							</td>
