...
//	}
	...
	function openCustomerPage() {
		...
		addForm.action = "changeCardOrderAction!add";
		addForm.submit();
	}
	...
	function orderSubmit(){ 
		...
		addForm.action = "${ctx}/changeCardOrderAction!insert";
		addForm.submit();
	}
 ...
 <%@ include file="/commons/messages.jsp"%>
	<div class="TitleHref">
		<span>订单管理>添加换卡订单基本信息</span>
	</div>
	<s:form id="addForm" name="addForm" action="changeCardOrderAction!insert" method="post">
		...
		<s:hidden id="sellOrderDTO.paymentTerm" name="sellOrderDTO.paymentTerm" value="2"></s:hidden>
		<s:hidden id="sellOrderDTO.paymentDelay" name="sellOrderDTO.paymentDelay" value="0"></s:hidden>
		<div id="ContainBox">
							...
							<div id="serviceTable">
								<table width="100%">
									...
									<tr>
										...
										<td>
											<s:textfield name="sellOrderDTO.origCardTotalAmt" id="origCardTotalAmount" readonly="true" cssClass="lg_text_gray"/>
											<s:fielderror>
												<s:param>
													sellOrderDTO.saleMan
												</s:param>
