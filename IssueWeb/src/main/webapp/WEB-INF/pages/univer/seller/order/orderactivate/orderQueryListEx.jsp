...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function orderActivate(orderId,orderType){
				...
				document.EditForm.action="orderConfirmAction!submitConfirm?buyOrderFlag=2&exFlag=2";
	...
	<body>
		...
		<s:form id="queryForm" name="queryForm"
								action="orderQueryAction!queryActivateEx?initFlag=1">
					...
					<td width="98%" height="10" align="center" valign="middle"
						...
						<ec:table items="sellOrders" var="map" width="100%" form="queryForm"
							...
							<ec:row ondblclick="javaScript:viewOrder('${map.orderId}','${map.orderType}');">
								...
								<ec:column title="操作" property="initActStat" sortable="false" width="7%" viewsAllowed="html">									
