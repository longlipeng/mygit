...
<html>
	<head>
								...
								<table width="100%">
									...
									<tr>
										<td width="15%" align="right" nowrap="nowrap">
											<span style="color: red;">*</span>订单发起者编号：
										</td>
										<td width="35%" align="left" nowrap="nowrap">
											<s:label name="sellOrderDTO.firstEntityId"/>
										</td>
										<td width="15%" align="right" nowrap="nowrap">
											<span style="color: red;">*</span>订单发起者名称：
										</td>
										<td width="35%" align="left" nowrap="nowrap">
									...
									<tr>
										...
										<td width="15%" align="right" nowrap="nowrap">
											<span style="color: red;">*</span>订单处理者：
										</td>
										<td width="35%" align="left" nowrap="nowrap">
		...
		<div style="width: 100%" align=center>
			...
			<!-- <input name="sellOrderDTO.orderContact" id="contact"/>	 -->
</body>
</html>