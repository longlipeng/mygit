...
// 		}
		...
		newForm.action = "buyOrderUnSignAction!update";
		newForm.submit();
	}
		...
		function delOpr(){
			document.EditForm.action = "buyOrderUnSignAction!deleteOrderList";
		  	document.EditForm.submit();			
		}


		function editRecord(orderListId){
            var returnValue = window.showModalDialog('${ctx}/buyOrderUnSignAction!editOrderList?sellOrderListDTO.productId=${sellOrderDTO.productId}&sellOrderListDTO.orderListId='+orderListId, '_blank', 'center:yes;dialogHeight:400px;dialogWidth:600px;resizable:no');           
			if(returnValue==1){			 
			  	document.EditForm.action = "buyOrderUnSignAction!edit";
			  	document.EditForm.submit();
			  }	  
		}
				...
				<table width="98%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr>
						<td width="98%" height="10" align="center" valign="middle"
							...
							<div id="TableBody">
								<s:form id="EditForm" name="EditForm" action="buyOrderUnSignAction!edit"
									method="post">
								...
								<ec:table items="customerOrderLists" var="map" width="100%" form="EditForm"
									action="${ctx}/buyOrderUnSignAction!edit"
