...
<script type="text/javascript">
	...
	function verifyIdNo() {
		...
		ajaxRemote('${ctx}/cardholder/checkOtherIdNo.action', {
			'cardholderDTO.idNo' : idNo,
			'cardholderDTO.idType' : type,
			'cardholderDTO.cardholderId' : cardholderId
		}, successFn, 'json');
	}
   ...
   function submit1(){
	   ...
	   if(verifyIdNo()==false){
		...
		submitForm('cardholderForm', '${ctx}/cardholder/update.action');
   }
</script>
<title>编辑持卡人信息</title>
</head>
<body>
    ...
    <s:form id="cardholderForm" name="cardholderForm" action="cardholder/insert.action" method="post">
       	<s:hidden name="a"></s:hidden>
       	<s:token></s:token>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td><s:textfield id="entityId" name="cardholderDTO.entityId" cssClass="readonly" readonly="true"/>
                                        <s:fielderror>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td><s:textfield id="customerName" name="cardholderDTO.customerDTO.customerName" cssClass="readonly"/></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <s:select list="cardholderDTO.customerDTO.departmentList" listKey="departmentId" listValue="departmentName" name="cardholderDTO.departmentId" id="department" headerKey="" headerValue=""></s:select>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <%-- <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td><s:textfield name="cardholderDTO.externalId" maxlength="100"/>
                                        <s:fielderror>
                ...
                <table width="100%" style="table-layout: fixed;">
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td><s:textfield name="cardholderDTO.cardholderId" readonly="true" cssClass="readonly"/></td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td><s:textfield name="cardholderDTO.firstName" maxlength="20"/>
                                        <s:fielderror>
                    ...
                    <tr>
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    <td style="width: 90px; text-align: right;"><span style="color: red">*</span>证件类型：</td>
                                    <td>
                                        <edl:entityDictList displayName="cardholderDTO.idType" dictValue="${cardholderDTO.idType}" props="id=\"paymentType\"" dictType="140" tagType="2" defaultOption="false" /> 
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    <td style="width: 90px; text-align: right;"><span style="color: red">*</span>证件号：</td>
                                    <td>
	                                    <%-- <s:textfield id="idNo" name="cardholderDTO.idNo" disabled="true" /> --%>
	                                    <s:textfield id="idNo" name="cardholderDTO.idNo" onblur="verifyIdNo();" maxlength="18"/> 
                                        <s:fielderror>
                    ...
                    <tr>
								...
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											...
											dictValue="${cardholderDTO.cardholderEducation}" dictType="116"
											tagType="2" defaultOption="false" />
											<s:fielderror>
								...
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											...
											dictValue="${cardholderDTO.cardholderMarriage}" dictType="117"
											tagType="2" defaultOption="false" />
											<s:fielderror>
	                    ...
	                    <tr>
	                        <td colspan="2">
	                            <table style="text-align: left; width: 100%">
	                                <tr>
	                                    <td style="width: 90px; text-align: right;"><span style="color: red">*</span>手机号码：</td>
	                                    <td><s:textfield name="cardholderDTO.cardholderMobile" maxlength="11" id="cardholderMobile"/>
	                                        <s:fielderror>
	                                            <s:param>cardholderDTO.cardholderMobile</s:param>
	                                        </s:fielderror>
	                                    </td>
	                                    <td style="width: 90px; text-align: right;"><span style="color: red">*</span>邮寄地址：</td>
	                                    <td><s:textfield id="mailingAddress" name="cardholderDTO.mailingAddress" onchange="checkMailingAddress();" maxlength="75"/>
	                                        <s:fielderror>
        ...
        <div id="personalInfo" style="background-color: #FBFEFF; border: 1px solid #B9B9B9;">
            ...
            <div id="personalInfoTable" style="padding: 5px; border-style: solid none none; border-width: 1px; border-color: #B9B9B9;">
                <table width="100%" style="table-layout: fixed;">
                    <tr>
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <edl:entityDictList displayName="cardholderDTO.cardholderGender" dictValue="${cardholderDTO.cardholderGender}" dictType="10002" tagType="2" defaultOption="false" />
                                    	<s:fielderror>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <s:textfield name="cardholderDTO.cardholderBirthday" onclick="dateClick(this)" cssClass="Wdate" cssStyle="cursor:pointer">
                                        </s:textfield>
                                        <s:fielderror>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <edl:entityDictList displayName="cardholderDTO.cardholderSegment" dictValue="${cardholderDTO.cardholderSegment}" dictType="103" tagType="2" defaultOption="false" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <edl:entityDictList displayName="cardholderDTO.cardholderSalutation" dictValue="${cardholderDTO.cardholderSalutation}" dictType="104" tagType="2" defaultOption="false" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <edl:entityDictList displayName="cardholderDTO.cardholderFunction" dictValue="${cardholderDTO.cardholderFunction}" dictType="105" tagType="2" defaultOption="false" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="2">
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td><s:textarea name="cardholderDTO.cardholderComment" onpropertychange="if(value.length>200) value=value.substr(0,200)" rows="5" cols="70"></s:textarea>
                                        <s:fielderror>
          ...
          <div id="allCardInfo" style="background-color: #FBFEFF; border: 1px solid #B9B9B9; ">
            ...
            <div id="allCardInfoTable" style=" border-style: solid none none; border-width: 1px; border-color: #B9B9B9;">
                <ec:table items="cardholderDTO.cardholderCardList.data" var="map" width="100%"
					...
					form="cardholderForm" action="${ctx}/cardholder/edit.action">
                    <ec:row>
