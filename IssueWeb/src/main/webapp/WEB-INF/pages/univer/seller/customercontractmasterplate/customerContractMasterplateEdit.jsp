...
<script type="text/javascript">
	...
	function addProduct(){
		...
		var returnValue = window.showModalDialog('${ctx}/customerContract/addProductMasterplateService.action?sellerContractDTO.sellContractId='+sellerContractId+'&nameSpace=${nameSpace}', 
	...
	function reload(){
		document.productContractFrom.action="${ctx}/customerContract/editMasterplate.action";
	...
	function sub(){
    	...
    	document.contractForm.action = '${ctx}/customerContract/updateMasterplate.action';
...
<body>
    ...
    <s:form id="contractForm" name="contractForm" action="sellerContract/insert.action" method="post">
    	...
    	<s:hidden id="sellerContractDTO.contractType" name="sellerContractDTO.contractType" />
