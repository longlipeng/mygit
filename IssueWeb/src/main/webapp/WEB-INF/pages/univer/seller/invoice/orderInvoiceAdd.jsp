...
<html>
	<head>
		...
		function sub(){
			var invoiceTitle = document.getElementById("orderInvoiceInfoDTO.invoiceTitle").value;
			if(IsSpace(invoiceTitle)){
			    errorDisplay("发票抬头必须输入!");
			    return;
			}
			maskDocAll();
			var queryForm = document.getElementById("newForm");
			queryForm.action = "${ctx}/orderQueryAction!addOrderInvoice.action";
			queryForm.submit();
		}
 </script>
	...
	<body>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="orderInvoiceInfoDTO.invoiceTitle" id="orderInvoiceInfoDTO.invoiceTitle" maxlength="80"></s:textfield>
														<s:fielderror>
														<s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<dl:dictList displayName="orderInvoiceInfoDTO.invoiceType"
														dictType="182" tagType="2" dictValue="${orderInvoiceInfoDTO.invoiceType}"></dl:dictList>
														<s:fielderror>
														<s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<dl:dictList displayName="orderInvoiceInfoDTO.invoiceProj"
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<input type="text" name="orderInvoiceInfoDTO.customerExpectedDate" onclick="dateClick(this)" 
															class="Wdate"   value="<s:date format="yyyy-MM-dd" name="orderInvoiceInfoDTO.customerExpectedDate" />"/>
														<s:fielderror>
														<s:param>
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<dl:dictList displayName="orderInvoiceInfoDTO.sendoutWay"
										...
										<td>
											<table style="text-align: left; width: 100%">
												<tr>
													...
													<td>
														<s:textfield name="orderInvoiceInfoDTO.userName" readonly="true" cssClass="readonly"></s:textfield>
														<s:fielderror>
														<s:param>
															orderInvoiceInfoDTO.userName
														</s:param>
														</s:fielderror>														
													</td>
												</tr>
		...
		<div id="btnDiv" style="text-align: right; width: 100%">
			<button class='bt' type="button"
				...
				onclick="window.location='${ctx}/orderQueryAction!query'">
				返 回
			</button>
