...
<script type="text/javascript">
    ...
    function sub(){
   	/* 	if(document.getElementById("punishRecordFlag").value==1&&document.getElementById("customerDTO.punishRecordInfo").value==''){
   		...
   		submitForm('customerForm', '${ctx}/customer/updateInfo.action');
   }
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:textfield name="customerDTO.regiName" maxlength="10" id="regiName" onblur="setCustomerName()"/>
											<s:fielderror>
						...
						<tr>
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										<td style="width: 100px; text-align: right;">
											<span class="no-empty">*</span>实际控制人证件有效期开始时间：
										</td>
										<td>
