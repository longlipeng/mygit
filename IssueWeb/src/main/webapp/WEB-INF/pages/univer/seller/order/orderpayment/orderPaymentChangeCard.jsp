...
<html>
	...
	<body onload="onBankChange();onCusBankChange();onOperChange()">
		<div id="ContainBox">
						...
						<table width="100%" height="20" border="0" cellpadding="0"
							...
							<tr>
								<td class="TableTitleFront"
									onclick="displayTableBody('orderTable')"
		...
		<div id="ContainBox" style="width: 100%" align="center">
			<table width="98%" border="0" cellpadding="0" cellspacing="1"
				bgcolor="B5B8BF">
				<tr>
					<td colspan="4" width="98%" height="10" align="center"
						...
						<div id="serviceTable">
							<table width="100%">
								<tr>
									...
									<td width="35%" align="left" nowrap="nowrap">
										<dl:dictList dictType="901" tagType="2"
											displayName="sellOrderDTO.payChannel"
											dictValue="${sellOrderDTO.payChannel}"></dl:dictList>
									</td>
									<td align="right" width="15%" nowrap="nowrap">
										付款明细:
									</td>
								...
								<tr>
									...
									<td width="35%" align="left" nowrap="nowrap">
										<s:textfield name="customerDTO.corpName" size="20"
									...
									<td width="35%" align="left" nowrap="nowrap">
										<s:textfield name="customerDTO.corpPhone" size="20"
											readonly="true" cssClass="lg_text_gray" />
									</td>
								</tr>
								<tr>
									...
									<td width="35%" align="left" nowrap="nowrap">
										<s:textfield name="customerDTO.corpCredId" size="20"
											readonly="true" cssClass="lg_text_gray" />
									</td>
								</tr>
								<tr>
									...
									<td width="35%" align="left" nowrap="nowrap">
										<s:textfield name="customerDTO.corpCredStaValidity" size="20"
											readonly="true" cssClass="lg_text_gray" />
									</td>
									<td align="right" width="15%" nowrap="nowrap">
										(至):
									...
									<td width="35%" align="left" nowrap="nowrap">
										<s:textfield name="customerDTO.corpCredEndValidity" size="20"
											readonly="true" cssClass="lg_text_gray" />
									</td>
								</tr>
								<tr>
									...
									<td width="35%" align="left" nowrap="nowrap">
										<s:select disabled="true" list="customerDTO.contractList"
									...
									<td width="35%" align="left" nowrap="nowrap">
										<s:textfield name="customerDTO.operPhone" id="operPhone"
											size="20" readonly="true" cssClass="lg_text_gray" />
									</td>
								</tr>
								<tr>
									...
									<td width="35%" align="left" nowrap="nowrap">
										<edl:entityDictList props="id='operCreType' disabled='true'"
									...
									<td width="35%" align="left" nowrap="nowrap">
										<s:textfield name="customerDTO.operCredId" size="20"
											id="operCredId" readonly="true" cssClass="lg_text_gray" />
									</td>
								</tr>
								<tr>
									<td align="right" width="15%" nowrap="nowrap">
									...
									<td width="35%" align="left" nowrap="nowrap">
										<s:textfield name="customerDTO.corpCredStaValidity"
											id="operStarValidity" size="20" readonly="true"
									...
									<td width="35%" align="left" nowrap="nowrap">
										<s:textfield name="customerDTO.corpCredEndValidity"
											id="operEndValidity" size="20" readonly="true"
											cssClass="lg_text_gray" />
									</td>
								</tr>
							</table>
							...
							<table width="100%">
								<tr>
									...
									<td width="20%" align="left" nowrap="nowrap">
										<s:select name="sellOrderDTO.intoBankId" id="bankNames"
											list="sellOrderDTO.lstBankDTO" listKey="bankId"
											listValue="bankName" onchange="onBankChange()"></s:select>
										<s:fielderror>
											<s:param>
									...
									<td width="20%" align="left" nowrap="nowrap">
										<s:textfield name="accountName" id="accountName" size="20"
											readonly="true" cssClass="lg_text_gray" />
									</td>
									<td align="right" width="13%" nowrap="nowrap">
										银行账号:
									...
									<td width="20%" align="left" nowrap="nowrap">
										<s:textfield name="bankAccount" id="bankAccount" size="20"
											readonly="true" cssClass="lg_text_gray" />
									</td>
								</tr>
							</table>
		...
		<div id="ContainBox" style="width: 100%" align="center">
			...
			<div id="TableBody" style="width: 98%">
				...
				method="post">
					...
					<s:hidden name="sellOrderDTO.orderType" id="sellOrderDTO.orderType"></s:hidden>
					<s:hidden name="sellOrderDTO.orderId" id="sellOrderDTO.orderId"></s:hidden>
					<s:hidden name="sellOrderDTO.paymentState" id="sellOrderDTO.paymentState"></s:hidden>
					...
					<td width="98%" height="10" align="center" valign="middle"
						...
						<div id="TableBody">
							<s:form id="origCardviewForm" name="origCardviewForm" action=""
								...
								<ec:table items="origCardList" var="map" width="100%"
									form="origCardviewForm"
									action="${ctx}/${actionName}!${actionMethodName}"
									imagePath="${ctx}/images/extremecomponents/*.gif" view="html"
									retrieveRowsCallback="limit" autoIncludeParameters="false"
									tableId="origCardList"
				...
				<table width="98%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr>
						<td width="98%" height="10" align="center" valign="middle"
							...
							<div id="TableBody">
								<s:form id="viewForm" name="viewForm" action="" method="post">
									<s:hidden name="sellOrderDTO.orderId"></s:hidden>
									<s:hidden name="sellOrderDTO.orderType"></s:hidden>
									<s:hidden name="sellOrderDTO.firstEntityId" />
									<s:hidden name="actionName" />
