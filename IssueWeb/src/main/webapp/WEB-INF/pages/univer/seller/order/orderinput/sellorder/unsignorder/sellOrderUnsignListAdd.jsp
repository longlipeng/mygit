		...
		Date.prototype.format = function(format)
		{
			...
			function submitForm() {
				...
				var now = new Date(); 
			 	...
			 	if(selectedDate!=null&&!IsSpace(selectedDate)){
	...
	<body onload="init();">
						...
						<td width="100%" height="10" align="left" valign="top"
							...
							<div id="serviceTable">
								<s:form id="newForm" name="newForm"
									action="sellOrderUnsignAction!insertOrderList" method="post">
									<s:hidden name="sellOrderDTO.orderId">
									</s:hidden>
									<s:hidden name="orderId" />
									<s:hidden name="sellOrderListDTO.faceValueType"
										id="sellOrderListDTO.faceValueType" />
									<s:hidden id="sellOrderListDTO.currentNowCount" />
									<s:hidden id="sellOrderListDTO.getProductDTO().MaxBalance"
										name="sellOrderListDTO.getProductDTO().MaxBalance" />
									<table width="100%">
										<tr>
											...
											<td width="35%" align="left" nowrap="nowrap" colspan="3">
												<s:select name="sellOrderListDTO.cardLayoutId"
													...
													listKey="cardLayoutId" listValue="cardName"
													onchange="changeCardLayout();">
												</s:select>
												<s:fielderror>
													<s:param>
										...
										<tr>
											...
											<td colspan="3">
												<img name="cardLayoutImg" id="cardLayoutImg"
													src="${ctx}/product/getCardLayOutImg.action?id=${sellOrderListDTO.cardLayoutId}"
		...
		<div>
			<p align="right">
				...
				<button class='btn'
					onclick="this.disabled='disabled';submitForm();var obj= this; setTimeout(function (){ obj.removeAttribute('disabled');},'5000');"
					style="float: right; margin: 5px">
					提 交
				</button>
			</p>
