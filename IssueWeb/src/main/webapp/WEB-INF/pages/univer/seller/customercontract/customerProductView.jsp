...
<div id="specialty" style="background-color: #FBFEFF; border: 1px solid #B9B9B9; margin: 5px 8px 0px;">
	<div id="${map.id}detailTitle" style="font-weight: bold; height: 19px; background-color: #DFE8F6;">
    ...
    <div id="${map.id}detailTable" style="padding: 5px; border-style: solid none none; border-width: 1px; border-color: #B9B9B9;">
    ...
    <div id="account" style="background-color: #FBFEFF; border: 1px solid #B9B9B9; ">
    	<div id="${map.id}accountTitle" style="font-weight: bold; height: 19px; background-color: #DFE8F6;">
	    	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	            <tr>
		                <td class="TableTitleFront" style="cursor: pointer">
    	...
    	<div id="${map.id}accountTable" style="background-color: #FBFEFF; padding: 5px; border-style: solid none none; border-width: 1px; border-color: #B9B9B9;">
    		<s:hidden id="sellerAcctypeContractDTO.id" name="sellerAcctypeContractDTO.id"/>
		       	<ec:table items="map.accDTOs" var="account" width="98%"
		            ...
		            <ec:row>
		               ...
		               <ec:column property="productId" title="产品号" width="15%"  />
		               <ec:column property="productName" title="产品名称" width="20%"  />
		               <ec:column property="fee" title="默认费率" width="10%"  />
		               <ec:column property="ruleNo" title="计算规则" width="10%" />
