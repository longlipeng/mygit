...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function setOrderContact(){
		var deliveryContactId ="${sellOrderDTO.orderContact}";
	...
	function orderSubmit(){ 	
		...
		newForm.action = "sellOrderUnsignAction!update";
		newForm.submit();
	}
	 ...
	 function addOrderList(orderId){
			...
			if(returnValue==1){			 
			  	document.newForm.action = "sellOrderUnsignAction!edit";
		...
		function delOpr(){
			document.EditForm.action = "sellOrderUnsignAction!deleteOrderList";
		...
		function editRecord(orderListId){
            var returnValue = window.showModalDialog('${ctx}/sellOrderUnsignAction!editOrderList?sellOrderListDTO.productId=${sellOrderDTO.productId}&sellOrderListDTO.orderListId='+orderListId, '_blank', 'center:yes;dialogHeight:400px;dialogWidth:600px;resizable:no');           
			if(returnValue==1){			 
			  	document.EditForm.action = "sellOrderUnsignAction!edit";
			  	document.EditForm.submit();
			  }	  
		}
		...
		var chooseBank = document.getElementById("bankNames").value;
			<s:iterator value="customerDTO.bankList" var="map">
			    ...
			    document.getElementById("bankAccountName").value="${map.bankAccountName}";
						...
						<td width="98%" height="10" align="center" valign="middle"
							...
							<div id="TableBody">
								...
								<ec:table items="customerOrderLists" var="map" width="100%" form="EditForm"
									action="${ctx}/sellOrderUnsignAction!edit"
									...
									<ec:row>
										...
										<ec:column sortable="false" property="null" title="操作">
