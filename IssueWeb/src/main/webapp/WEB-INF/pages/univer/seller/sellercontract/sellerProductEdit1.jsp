                ...
                <td>
                    <table style="text-align: left; width: 100%">
                        <tr>
                            ...
                            <td><s:textfield name="cardFeeShow" value="%{sellerProductContractDTO.cardFee / 100}" onchange="document.getElementById('cardFee').value = (this.value != null ? (this.value * 100) : 0)"></s:textfield>
                                <s:hidden name="sellerProductContractDTO.cardFee" id="cardFee"></s:hidden>
                                <s:fielderror>
                ...
                <td>
                    <table style="text-align: left; width: 100%">
                        <tr>
                            ...
                            <td><s:textfield name="annualFeeShow" value="%{sellerProductContractDTO.annualFee / 100}" onchange="document.getElementById('annualFee').value = (this.value != null ? (this.value * 100) : 0)"></s:textfield>
                                <s:hidden name="sellerProductContractDTO.annualFee" id="annualFee"></s:hidden>
                                <s:fielderror>
