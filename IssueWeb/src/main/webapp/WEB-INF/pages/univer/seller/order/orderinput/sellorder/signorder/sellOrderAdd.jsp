...
.phone { BORDER-RIGHT: #000000 0px solid; BORDER-TOP: #000000 0px solid; FONT-SIZE: 9pt; BACKGROUND: none transparent scroll repeat 0% 0%; OVERFLOW: hidden; BORDER-LEFT: #000000 0px solid; COLOR: black; BORDER-BOTTOM: #000000 0px solid}
...
//	}
	...
	var returnValue=null;
		...
		newForm.action = "sellOrderSignAction!add?orderType=${sellOrderDTO.orderType}";
		newForm.submit();
		}else{
		    returnValue = window.showModalDialog('${ctx}/customer/chooseCustomer.action?personFlag=con',
				'_blank',
				'center:yes;dialogHeight:400px;dialogWidth:650px;resizable:no');
		if (returnValue == null || returnValue == undefined)
			return;
		maskDocAll();
		document.getElementById("sellOrderDTO.firstEntityId").value=returnValue;
	...
	function productChange(select) {
		maskDocAll();
		newForm.action = "${ctx}/sellOrderSignAction!add?orderType="+${sellOrderDTO.orderType};
		newForm.submit();
	}
	...
	function orderSubmit(){ 	
		...
		var doublePatrn = /^(([1-9]{1}[0-9]{0,6})|([0]))$/;
		...
		/* if(parseFloat(printFaceValue)>1000000){
			errorDisplay("第一次充值金额不能超过100万!");
			return;
		} */
		...
		if(deliveryFee<0){
			...
			newForm.action = "sellOrderSignAction!insert";
			newForm.submit();
	...
	<body onload="loadSalesmanList();">
		...
		<s:form id="newForm" name="newForm" action="/sellOrderSignAction" method="post">
						...
						<td width="100%" height="10" align="left" valign="top"
							...
							<div id="serviceTable1">
								<table width="100%">
									...
									<tr>
											<s:hidden name="sellOrderDTO.validityPeriod" value="2099-12-31"></s:hidden>
<%--										<td width="15%" align="right" nowrap="nowrap">--%>
...
<%--										</td>--%>
			...
			<div id="ContainBox2" style="width: 100%" align="center">
				<table width="98%" border="0" cellpadding="0" cellspacing="1"
					bgcolor="B5B8BF">
					<tr>
					...
					<tr>
						<td align="right" width="15%" nowrap="nowrap">
							<s:textfield name="corpCredType" id="corpCredType" size='11' readonly="true" cssClass="phone" value="法人证件类型:"></s:textfield>
						</td>
						<td width="35%" align="left" nowrap="nowrap">
						...
						<td align="right" width="15%" nowrap="nowrap">
							<s:textfield name="corpCredId" id="corpCredId" size='11' readonly="true" cssClass="phone" value="法人证件号:"></s:textfield>
						</td>
						<td width="35%" align="left" nowrap="nowrap">
					...
					<tr>
						<td align="right" width="15%" nowrap="nowrap">
							<s:textfield name="corpCredStaValidity" id="corpCredStaValidity" size='18' readonly="true" cssClass="phone" value="法人证件有效期:(起)"></s:textfield>
						</td>
						<td width="35%" align="left" nowrap="nowrap">
			...
			<div id="ContainBox3" style="width: 100%" align="center">
				<table width="98%" border="0" cellpadding="0" cellspacing="1"
					bgcolor="B5B8BF">
					<tr>
						<td colspan="4" width="98%" height="10" align="center" valign="middle" bgcolor="#FFFFFF">
