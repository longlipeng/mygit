...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<s:form id="queryForm" name="queryForm"
			action="/ireport/queryWwarehouseFlowAction!viewReport.action" method="post">
				                <s:hidden name="warehouseFlowDTO.reportName"></s:hidden>
								<s:hidden name="warehouseFlowDTO.reportType"></s:hidden>
								<s:hidden name="warehouseFlowDTO.issuerId"></s:hidden>
								<s:hidden name="warehouseFlowDTO.issuerName"></s:hidden>
								<s:hidden name="warehouseFlowDTO.reportFileName"></s:hidden>
			<div id="base"
							...
							<td>
								<table style="text-align: right; width:100%">
									<tr>
										...
										<td align="left">
											<s:textfield name="warehouseFlowDTO.startDate" id="startDate"
												 size="20" onfocus="dateClick(this)"
												cssClass="Wdate">
											</s:textfield>
											<s:fielderror>
												<s:param>warehouseFlowDTO.startDate</s:param>
											</s:fielderror>
										</td>
										</tr>
								</table>
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:textfield name="warehouseFlowDTO.endDate" id="endDate"
												 size="20" onfocus="dateClick(this)" cssClass="Wdate">
											</s:textfield>
											<s:fielderror>
												<s:param>warehouseFlowDTO.endDate</s:param>
											</s:fielderror>
										</td>
									</tr>
								</table>
							...
							<table border="0" cellpadding="0" cellspacing="0">
								<tr height="35">
									    ...
									    <td align="right" colspan="3">
											 <input type="button" class="bt" id="dowBt" style="margin: 5px" onclick="submitForm();" value="下 载 报 表"/></td>
									</tr>
							</table>
						</td>
					</tr>
