...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function readyList(operation) {
				...
				stockForm.action='${ctx}/orderReadyAction!cardArrayReady';
				stockForm.submit();
			}
			...
			function cardSegmentReady(){
				...
				stockForm.action='${ctx}/orderReadyAction!cardSegmentReady';
			...
			function queryStock(){
				stockForm.action='${ctx}/orderReadyAction!cardReady';
				stockForm.submit();
			}
	...
	<body onload="cardNoInit()">
		...
		<s:hidden name="orderReadyDTO.productId" />
		<s:hidden name="orderReadyDTO.processEntityId" />
		<s:hidden name="orderReadyDTO.orderType"/>
				...
				<tr>
					<td width="98%" height="10" align="center" valign="middle"
						...
						<ec:table items="pageDataDTO.data" var="map" width="100%" form="stockForm"
							action="${ctx}/orderReadyAction!cardReady"
