...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			function submitForm(){
			    document.newForm.action = "stockTransferOrderReadyAction!sendBackOrderSubmit";
					...
					<td rowspan="2">
						<div id="btnDiv" style="text-align: right; width: 300px;">
							<button class='btn' style="float: right; margin: 40px 7px 2px"
								onclick="window.open('${ctx}/stockTransferOrderReadyAction!list', '_self')">
								返 回
							</button>
							<button class='btn' style="float: right; margin: 40px 7px 2px"
								onclick="submitForm();">
						...
						<td width="98%" height="10" align="center" valign="middle"
							...
							<div id="TableBody">
								...
								<ec:table items="orderListDTOs" var="map" width="100%" form="orderlistListForm"
									action="${ctx}/stockTransferOrderReadyAction!sendBackOrder"
