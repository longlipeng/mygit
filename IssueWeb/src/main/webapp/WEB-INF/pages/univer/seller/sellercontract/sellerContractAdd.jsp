...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function choiceSeller() {
		var sellerDTO = window.showModalDialog('${ctx}/seller/choice.action',
				'_blank',
	...
	function choiceSettleRule() {
		...
		var ruleResult = window.showModalDialog(
				'${ctx}/sellerConstract/settleRuleChoice.action', '_blank',
	 ...
	 function insertContract(){
    	...
    	document.getElementById("contractForm").action ='${ctx}/sellerConstract/insert.action';
	...
	<body>
		...
		<s:form id="contractForm" name="contractForm"
			action="sellerContract/insert.action" method="post">
			<div id="base"
								...
								<table style="text-align: left; width: 100%">
									<tr>
										<td style="width: 140px; text-align: right;">
											<span style="color: red">*</span>营销机构号：
										</td>
										<td>
											<s:textfield id="contractBuyer"
												name="sellerContractDTO.contractBuyer" cssClass="watch"
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:textfield id="sellerName"
												name="sellerContractDTO.contractBuyerName" readonly="true"
												cssClass="readonly" />
										</td>
									</tr>
								</table>
						...
						<tr>
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										<td style="width: 140px; text-align: right;">
											<span style="color: red">*</span>结算周期规则：
										</td>
										<td>
											<s:textfield id="ruleNo"
												name="sellerContractDTO.settlePeriodRule" cssClass="watch"
												readonly="true" onclick="choiceSettleRule()" />
											<s:fielderror>
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:textfield id="ruleName"
												name="sellerContractDTO.settlePeriodRuleName"
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										...
										<td>
											<s:select name="sellerContractDTO.contractState"
												list="#{'1':'有效', '0':'无效'}" />
											<s:fielderror>
						...
						<tr>
							...
							<td>
								<table style="text-align: left; width: 100%">
									<tr>
										<td style="width: 140px; text-align: right;">
											<span style="color: red">*</span>快递费：
										</td>
										<td>
											<s:textfield  id="fee" name="deliveryFeeShow"
												value="%{(sellerContractDTO != null && null != sellerContractDTO.deliveryFee && sellerContractDTO.deliveryFee!=0) ? (sellerContractDTO.deliveryFee / 100) : 0}"
												onchange="document.getElementById('deliveryFee').value = (this.value != null ? (this.value * 100) : 0)"
												readonly="sensitive"></s:textfield>
											<s:hidden name="sellerContractDTO.deliveryFee"
												id="deliveryFee"></s:hidden>
											<s:fielderror>
						...
						<td align="right">
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td>
										<input type="button" class="bt" style="margin: 5px"
											onclick="window.location = '${ctx}/sellerConstract/inquery.action';"
											value="返 回" />
								</tr>
							</table>
						</td>
