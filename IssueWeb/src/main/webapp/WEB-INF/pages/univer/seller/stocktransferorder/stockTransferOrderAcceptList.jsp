...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function accept(orderId){
				 EditForm.orderId.value = orderId;
				 document.EditForm.action = "stockTransferOrderAcceptAction!accept";
			...
			function sendBack(){
				...
				if (!flag) {
					EditForm.orderId.value = orderId;
				 	document.EditForm.action = "stockTransferOrderAcceptAction!sendBackAtAccept";
					document.EditForm.submit();
					return;
				}
				errorDisplay("请选择一条记录！");
			...
			function operation(){
				document.queryForm.action = "stockTransferOrderAcceptAction!closeStockTransferOrder";
				document.queryForm.submit();
			}
	...
	<body>
		...
		<div class="TitleHref">
			<span>调拨订单管理-->库存调拨订单入库</span>
		</div>
		
		<div id="ContainBox">
		<s:form id="queryForm" name="queryForm" action="stockTransferOrderAcceptAction!list">
				...
				<tr>
					<td width="98%" height="10" align="center" valign="middle"
						...
						<ec:table items="stockTransferOrders" var="map" width="100%" form="queryForm"
							action="${ctx}/stockTransferOrderAcceptAction!list"
							...
							<ec:row>
								...
								<ec:column property="null"  title="操作"  viewsAllowed="html">
                                       	 <a href="javascript:accept('${map.orderId}');"> 接收 </a>
                                </ec:column>
							</ec:row>
						</ec:table>
						</div>
