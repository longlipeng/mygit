					...
					if('${operation}' == 'sendback'){
				        ...
				        var options= {
				        	...
				        	success:TimeOperation(
				        			...
				        			"${ctx}/orderSendConfirmAction!list.action",
				        			'充值中,请耐心等候...','5s')};
		...
		<div id="orderTable">
			<table width="100%" border=0>
				<tr>
					...
					<td width="70%" align="left" nowrap="nowrap" rowspan="2"
						style="padding: 10px 0 0 0">
						<s:form id="confirmForm" name="confirmForm" method="post">
							...
							<s:hidden name="sellOrderDTO.createUser"></s:hidden>
