				       ...
				       <td>
							<table style="text-align: left; width: 100%">
								<tr>
									...
									<td>					
										<s:label name="companyInfoDTO.relationNo" disabled="true"/>
										<s:fielderror>
						...
						<td>
							<table style="text-align: left; width: 100%">
								<tr>
									...
									<td>
										<s:textfield name="companyInfoDTO.companyCountyr" maxlength="64" disabled="true"/>
										<s:fielderror>
					   ...
					   <td>
							<table style="text-align: left; width: 100%">
								<tr>
									...
									<td>
										<s:textfield name="companyInfoDTO.corpCountyr" maxlength="100" disabled="true"/>
										<s:fielderror>
		...
		<div id="allCardInfo" style="background-color: #FBFEFF; border: 1px solid #B9B9B9;">
            ...
            <div id="allCardInfoTable" style="border-style: solid none none; border-width: 1px; border-color: #B9B9B9;">
                <ec:table items="cardholderDTO.cardholderCardList.data" var="map" width="100%"
                    ...
                    view="html"
                    autoIncludeParameters="false" tableId="cardInfo" form="cardholderForm" action="${ctx}/cardholder/cusView.action">
                    <ec:row>
                ...
                <tr>
                    <td align="right">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                <input type="hidden" name="companyInfoDTO.relationNo"  value="${companyInfoDTO.relationNo}" />
                                <s:if test="cardManagementDTO.dataState==1">
	                                <%-- <input type="button" class="bt" style="margin: 5px" onclick="submitForm('cardholderForm', '/IssueWeb/cardholder/checkCusUpdate.action?JudgeInforDTO.entityID=${companyInfoDTO.relationNo}&JudgeInforDTO.CName=${companyInfoDTO.customerDTO.customerName}&JudgeInforDTO.userType=2&JudgeInforDTO.judgeType=5&JudgeInforDTO.customerType=2')" value="黑名单标识"/>
	                                 --%>
	                                <input type="button" class="bt" style="margin: 5px" onclick="submitForm('cardholderForm', '/IssueWeb/cardholder/checkCusUpdate.action?companyInfoDTO.verifyStat=1')" value="通过"/>
	                                <input type="button" class="bt" style="margin: 5px" onclick="submitForm('cardholderForm', '/IssueWeb/cardholder/checkCusUpdate.action?companyInfoDTO.verifyStat=3')" value="不通过"/>
                                </s:if>
                                <s:else>
	                                <input type="button" class="bt" style="margin: 5px" onclick="submitForm('cardholderForm', '/IssueWeb/cardholder/checkCusUpdate.action?companyInfoDTO.verifyStat=2')" value="提交"/>
