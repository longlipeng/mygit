...
<script type="text/javascript">
    ...
    function choiceSeller() {
        var sellerDTO = window.showModalDialog('${ctx}/seller/choice.action', '_blank', 'center:yes;dialogHeight:600px;dialogWidth:800px;resizable:no');
        if (sellerDTO != null) {
	...
	function reload(){
		document.productContractFrom.action="${ctx}/sellerConstract/edit.action";
	 ...
	 function insertContract(){
    	...
    	document.getElementById("contractForm").action ='{ctx}/sellerConstract/update.action'
	    ...
	    <s:if test="productContractDTOs != null">
	    	<s:form id="productContractFrom" name="productContractFrom" action="" method="post">
		    	...
		    	<s:iterator value="productContractDTOs" id="map" var="map">
		    		...
		    		<!-- 服务明细 -->
			        <s:include value="sellerProductView.jsp" />
