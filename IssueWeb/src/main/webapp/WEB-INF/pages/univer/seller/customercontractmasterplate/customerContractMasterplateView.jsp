   ...
   <%@ include file="/commons/messages.jsp"%>
                ...
                <table width="100%" style="table-layout: fixed;">
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>${sellerContractDTO.contractBuyer}</td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>${sellerContractDTO.contractBuyerName}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>${sellerContractDTO.settlePeriodRule}</td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>${sellerContractDTO.settlePeriodRuleName}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>${sellerContractDTO.expiryDate}</td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                    	<c:if test="${sellerContractDTO.contractState eq 1}">有效</c:if>
                                    	<c:if test="${sellerContractDTO.contractState eq 0}">无效</c:if>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>${sellerContractDTO.deliveryFee/100} </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    <td style="width: 140px; text-align: right;"><span style="color: red"></span> </td>
                                    <td>
                                        &nbsp;
                                    </td>
                                </tr>
	...
	<s:iterator value="productContractDTOs" id="map" var="map">
		<div id="specialty" style="background-color: #FBFEFF; border: 1px solid #B9B9B9; margin: 5px 8px 0px;">
			<div id="${map.id}specialtyTitle" style="font-weight: bold; height: 19px; background-color: #DFE8F6;">
		        <table width="100%" border="0" cellpadding="0" cellspacing="0">
		            <tr>
		    ...
		    <div id="${map.id}specialtyTable" style="padding: 5px; border-style: solid none none; border-width: 1px; border-color: #B9B9B9;">
		    ...
		    <div id="service" style="background-color: #FBFEFF; border: 1px solid #B9B9B9; margin: 20px 8px 0px;">
			    <div id="" style="background-color: #FBFEFF; padding: 5px; border-style: solid none none; border-width: 1px; border-color: #B9B9B9;">
			    	<s:hidden id="sellerAcctypeContractDTO.id" name="sellerAcctypeContractDTO.id"/>
			       	<ec:table items="map.accDTOs" var="account" width="100%"
                ...
                <tr>
                    <td align="right">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                   <input type="button" class="bt" style="margin: 5px" onclick="window.location = '${ctx}/customerContract/masterPlatelist.action';" value="返 回"/>
                                </td>
                            </tr>
                        </table>
                    </td>
