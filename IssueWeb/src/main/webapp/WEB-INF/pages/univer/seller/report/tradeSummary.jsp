...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<s:form id="queryForm" name="queryForm"
			action="/ireport/queryTradeSummaryAction!viewReport.action" method="post">
				                <s:hidden name="tradeSummaryDTO.reportName"></s:hidden>
								<s:hidden name="tradeSummaryDTO.reportType"></s:hidden>
								<s:hidden name="tradeSummaryDTO.issuerId"></s:hidden>
								<s:hidden name="tradeSummaryDTO.issuerName"></s:hidden>
								<s:hidden name="tradeSummaryDTO.reportFileName"></s:hidden>
			<div id="base"
				...
				<div id="baseTable"
					...
					<table width="80%" style="table-layout: fixed; text-align:center">
						<tr>
							<td>
								<table style="text-align: right; width: 60%">
									<tr>
										<td style="width: 140px; text-align: right;">
											<span style="color: red">*</span>开始时间：
										</td>
										<td>
											<s:textfield name="tradeSummaryDTO.startDate" id="startDate"
							...
							<td>
								<table style="text-align: left; width: 60%">
									<tr>
										...
										<td>
											<s:textfield name="tradeSummaryDTO.endDate" id="endDate"
