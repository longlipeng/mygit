...
<br/>
<br/>
<div  align="center"><font style="line-height:30px;font-size=22px;font-weight:bold;" >${sellOrderDTO.processEntityName}客户购卡凭证（记名卡）  </font>打印日期:${sellOrderDTO.printDate}</div>
<div align="center"><table width="80%" border="solid 1px;">
	<tr>
	...
	<tr>
		...
		<td>
			<table width="100%">
				...
				<s:iterator value="sellOrderDTO.orderCardListDTOList" var="orderCardList">
					<tr>
						<td>${orderCardList.cardNo }</td>
						<td>${orderCardList.creditAmount }</td>
						<td>${orderCardList.firstName }</td>
						<td><dl:dictList dictType="140" tagType="1" dictValue="${orderCardList.certType}"></dl:dictList>   </td>
						<td>${orderCardList.certNo }</td>
					</tr>
				</s:iterator>
			</table>
		</td>
