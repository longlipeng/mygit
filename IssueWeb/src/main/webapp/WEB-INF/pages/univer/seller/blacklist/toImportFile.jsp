...
<script type="text/javascript" src="${ctx}/widgets/js/common2.js"></script>
	<script type="text/javascript">
		...
		function  submitForm(){
			var flag = document.getElementById('blackListDTO.flag').value;
			if(flag == ''){
			...
			$("#button1").removeAttr("class");
				queryForm.action="${ctx}/blacklistRegion/importBlackListFile.action";
				document.queryForm.submit();
		}
		
		function backForm(){
			queryForm.action="${ctx}/blacklistRegion/inquery.action";
			document.queryForm.submit();
		}
								...
								<table style="text-align: right; width: 55%">
									<tr>
										...
										<td width="35%" align="left" nowrap="nowrap">
											<s:select name="blackListDTO.flag" id="blackListDTO.flag" list="#{'':'--请选择--','1':'持卡人黑名单','2':'地区黑名单'}"/>
										</td>
									</tr>
									<tr>
										<td align="right" width="15%" nowrap="nowrap">
