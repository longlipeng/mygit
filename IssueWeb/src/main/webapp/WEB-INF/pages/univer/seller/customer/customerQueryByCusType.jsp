					...
					<td width="100%" height="10" align="left" valign="top"
						...
						<div id="QueryBody">
							<s:form id="queryForm" name="queryForm"
								action="customer/chooseCustomerByCusType">
								<table>
									<tr>
										...
										<td>
											<s:textfield name="customerQueryDTO.entityId" size="14" />
										...
										<td>
											<s:select name="customerQueryDTO.customerType" list="#{'':'--全部--','0':'企业客户','1':'个人客户'}"></s:select>
											&nbsp;
										</td>
										  <td width="65" align=right>证件号码：</td>
						...
						<div id="TableBody">
							<s:form id="EditForm" name="EditForm"
								...
								<ec:table items="pageDataDTO.data" var="map" width="100%" form="EditForm"
									action="${ctx}/customer/chooseCustomerByCusType"
