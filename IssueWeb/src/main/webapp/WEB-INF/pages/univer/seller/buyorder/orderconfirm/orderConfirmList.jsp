...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function submitForm(method) {
				...
				if(count==1){
						document.EditForm.action="orderConfirmAction!"+method+"?buyOrderFlag=1";
	...
	<body>
		...
		<div class="TitleHref">
			<span>订单管理-->采购订单审核</span>
		</div>
		
		<div id="ContainBox">
		<s:form id="queryForm" name="queryForm"
								action="orderConfirmAction!listBuyOrder">
				...
				<tr>
					<td width="98%" height="10" align="center" valign="middle"
						...
						<ec:table items="sellOrders" var="map" width="100%" form="queryForm"
							action="${ctx}/orderConfirmAction!listBuyOrder"
								...
								<tr>
									<td>
										<div id="buttonCRUD"
											...
											valign="middle">
											<display:security urlId="4101203">
												<div id="deleteBtn" class="btn"
													...
													onclick="return submitForm('cancelConfirm');">
													取消
												</div>
											</display:security>
											<display:security urlId="4101202">
											...
											<display:security urlId="4101201">
