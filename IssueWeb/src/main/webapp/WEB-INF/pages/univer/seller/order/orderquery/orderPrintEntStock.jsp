...
<br/>
<br/>
<div  align="center"><font style="line-height:30px;font-size=22px;font-weight:bold;" >入库凭证</font> 打印日期:${sellOrderDTO.printDate}</div>
<div align="center"><table width="80%" border="1px solid">
	<tr>
		<td class="title">卡片来源</td>
		<td>
			机构名称:${sellOrderDTO.processEntityName}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
		...
		<td>
			...
			操作时间:${sellOrderDTO.orderFlowDTO.createTime}
		</td>
	</tr>
	<tr>
		<td class="title">
