...
<script type="text/javascript">
    ...
    maskDocAll();
		...
		document.sellerForm.action='${ctx}/seller/insert.action';
		document.sellerForm.submit();
   	}
   	 function record(){
             var id=window.showModalDialog('${ctx}/seller/record', '_blank', 'center:yes;dialogHeight:400px;dialogWidth:600px;resizable:no');
              sellerForm.action='seller/configEntiyId.action?sellerQueryDTO.entityId='+id;      
              sellerForm.submit();
     }
</script>
...
<body onload="loadPage()">
    ...
    <s:form id="sellerForm" name="sellerForm" action="customerManagement/insert.action" method="post">
    	...
    	<s:hidden name="sellerDTO.functionRoleId" id="functionRoleId" value="3" />
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                    	<s:textfield name="sellerDTO.entityId" readonly="true"/>
