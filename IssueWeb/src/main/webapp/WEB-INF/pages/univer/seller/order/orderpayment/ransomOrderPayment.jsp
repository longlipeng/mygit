						...
						<td width="100%" height="10" align="left" valign="top"
							...
							<div id="orderTable">
								<table width="100%">
									...
									<tr>
<!--										<td width="15%" align="right" nowrap="nowrap">-->
<!--											<span style="color: red;">*</span>卡片类型：-->
<!--										</td>-->
<!--										<td width="35%" align="left" nowrap="nowrap">-->
<!--											<dl:dictList displayName="sellOrderDTO.cardType"  dictValue="${sellOrderDTO.cardType}" dictType="816" defaultOption="false" tagType="1" />-->
<!--										</td>-->
						...
						<td width="98%" height="10" align="center" valign="middle"
							...
							<table width="100%" height="20" border="0" cellpadding="0"
								...
								<tr>
									<td class="TableTitleFront" onclick="displayTableBody();"
										style="cursor: pointer;">
										<span class="TableTop">赎回卡信息</span>
									</td>
									<td class="TableTitleEnd">
										&nbsp;
									</td>
									...
									<s:hidden name= "operation"/>
										...
										<ec:table items="orderPaymentList" var="map" width="100%" form="paymentForm"
											...
											<ec:row>
												...
												<ec:column property="paymentAmount" title="金额" width="15%" />
