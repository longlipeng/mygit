...
<script type="text/javascript">
    ...
    function choiceProduct() {
        ...
        var productId = window.showModalDialog('${ctx}/sellerConstract/productChoice.action?sellerContractQueryDTO.sellContractId=${sellerContractDTO.sellContractId}&sellerContractQueryDTO.sellContractId=${sellerContractDTO.contractBuyer}', '_blank', 'center:yes;dialogHeight:600px;dialogWidth:700px;resizable:no');
        if (productId != null) {
    ...
    function sub(){   
    	...
    	document.productForm.action = '${ctx}/sellerConstract/insertProductService.action';
    	document.productForm.submit();
