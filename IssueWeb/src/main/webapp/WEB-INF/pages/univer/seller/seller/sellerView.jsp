...
<script type="text/javascript">
    ...
    function changeBusinessCity() {
        ...
        if (salesRegions != null) {
            ...
            businessAreaSelect.disabled = true;
        }
    }
                    	...
                    	<td>
                             <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                    	<s:label name="sellerDTO.sellerCode"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                       <%--  
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    <td style="width: 100px; text-align: right;"><span class="no-empty">*</span>失效4444时间：</td>
                                    <td>
                         ...
                         <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <edl:entityDictList displayName="sellerDTO.salesRegionId" dictValue="${sellerDTO.salesRegionId}" dictType="407" tagType="2" defaultOption="false" props="disabled=\"true\""/>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <s:select list="salesmanList" name="sellerDTO.salesmanId" listKey="userId" listValue="userName" headerKey="" headerValue="" disabled="true"></s:select>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table style="text-align: left; width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <edl:entityDictList displayName="sellerDTO.activitySector" dictValue="${sellerDTO.activitySector}" dictType="400" tagType="2" defaultOption="false" props="disabled=\"true\""/>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <tr>
                    <td align="right">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <input type="button" class="bt" style="margin: 5px" onclick="sellerForm.action='seller/inquery.action';sellerForm.submit();" value="返 回"/>
                                </td>
                            </tr>
                        </table>
                    </td>
