...
public class Const {
	...
	//借贷标识
	public static final String DEBT_OR_CREDIT = "借/贷,";
	//原卡卡号
	public static final String ORIG_CARD_NO = "原卡卡号,";
	//商户号
	public static final String MCHNT_CD = "商户号,";
	//商户名
	public static final String MCHNT_NAME = "商户名,";
	//终端号
	public static final String TERM_ID = "终端号";
	...
	// 购卡人审核操作类型(不通过)
	public static final String AUDIT_NOPASS = "3";
	// 购卡人审核操作类型(黑名单校验)
	public static final String AUDIT_BLACK_CHECK = "5";
	// 购卡人审核操作类型(风控校验)
	public static final String AUDIT_RISK_GRADE = "4";
}
