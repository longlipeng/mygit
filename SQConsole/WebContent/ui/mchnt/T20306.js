Ext.onReady(function() {
	...
	var reasonColModel = new Ext.grid.ColumnModel([
		...
		{header: '操作员所属分公司',dataIndex: 'brhID',width: 100},
		...
		{header: '卡类型',dataIndex: 'param2',width: 100,id:'param2',renderer: cardTypeT},
		{header: '单日单笔交易金额',dataIndex: 'param3',width: 100,id:'param3'},
		{header: '单日累计交易金额',dataIndex: 'param4',width: 100,id:'param4'},
		{header: '单月累计交易金额',dataIndex: 'param5',width: 100,id:'param5'},
		...
		buttons : [ {
			...
			reasonStore.load({
				params : {
					...
					mchnNoQ: queryForm.findById('mchnNoQ').getValue()
					}
				});
		}
		}, {
