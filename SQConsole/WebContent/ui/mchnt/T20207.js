Ext.onReady(function() {	
	...
	var mchntStore = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({
			url: 'gridPanelStoreAction.asp?storeId=mchntCheckInfo4Add1'
		}),
	...
	var mchntColModel = new Ext.grid.ColumnModel([
		...
		{header: '提交人',dataIndex: 'crtOprId',width: 120,renderer:getOpr},
	...
	var auditMenu = {
		...
		handler:function(bt) {
			...
			auditMchnt4Add(mchntGrid.getSelectionModel().getSelected().get('mchtNo'),mchntGrid);			
		}
	};
