...
//		region: 'south',
	...
	var setColumnModel = new Ext.grid.ColumnModel([
		new Ext.grid.RowNumberer(),
		{header: '终端号',dataIndex: 'termId',sortable: true,width: 60},
		{header: '商户结算周期',dataIndex: 'settleType',sortable: true,width:90,renderer:settleTypeVal},
...
//		{header: '结算账户类型',dataIndex: 'settleRpt',sortable: true,width:60,renderer:settleRptVal},
		{header: '商户当前使用账号',dataIndex: 'currAccount',sortable: true,width:100},
		...
		{header: '公司账号开户名',dataIndex: 'settleAcctNm',sortable: true,width:100},
		{header: '公司账号',dataIndex: 'settleAcct',sortable: true,width:100},
		...
		{header: '法人账号开户名',dataIndex: 'feeAcctNm',sortable: true,width:100},
		{header: '法人账号',dataIndex: 'feeAcct',sortable: true,width:100},
		...
		{header: '定向委托付款标志',dataIndex: 'dirFlag',sortable: true,width:100,renderer:flagVal},
