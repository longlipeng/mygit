Ext.onReady(function() {
	...
	//	{header: '操作员所属分公司',dataIndex: 'brhID',width: 120},
		...
		{header: '代理商编号',dataIndex: 'param1',width: 200,sortable: true ,renderer:function(val){return getRemoteTrans(val, "getAgentNm");}},
		{header: '分润方式',dataIndex: 'param2',width: 100,renderer:function(val){return getRemoteTrans(val, "divideType");}},
		{header: '代理商分润下限值(万元)',dataIndex: 'param3',width: 150},
		{header: '代理商分润上限值(万元)',dataIndex: 'param4',width: 150},
		{header: '分润参数',dataIndex: 'param5',width: 150},
		{header: '拒绝原因',dataIndex: 'refuseInfo',width: 300}
	]);
