Ext.onReady(function() {
	...
	var reasonColModel = new Ext.grid.ColumnModel([
		...
		{header: '费率编号',dataIndex: 'param1',width: 80,id:'param1'},
		{header: '机构代码',dataIndex: 'param2',width: 190,id:'param2',renderer:function(val){return getRemoteTrans(val, "agenNm");}},
		{header: '终端号',dataIndex: 'param3',width: 80,id:'param3'},
	//	{header: '商户号',dataIndex: 'param4',width: 240,/*id:'param4'*/ renderer:function(val){return getRemoteTrans(val, "mchtIdName2");}},
		{header: '商户号',dataIndex: 'param4',width: 240,/*id:'param4'*/renderer:mchntRen},
		{header: 'MCC码',dataIndex: 'param5',width: 200,/*id:'param5'*/renderer:function(val){return getRemoteTrans(val, "mcc2");}},
		{header: '机构分润参数',dataIndex: 'param6',width: 120,id:'param6'},
