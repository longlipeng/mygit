Ext.onReady(function() {
	...
	var reasonColModel = new Ext.grid.ColumnModel([
		...
		{header: '源应答码',dataIndex: 'param1',width: 80,id:'param1'},
		{header: '目的应答码',dataIndex: 'param2',width: 80,id:'param2'},
		{header: '源应答码长度',dataIndex: 'param3',width: 80,id:'param3'},
		{header: '目的应答码长度',dataIndex: 'param4',width: 100,id:'param4'},
		{header: '源编号',dataIndex: 'param5',width: 80,id:'param5'},
		{header: '目的编号',dataIndex: 'param6',width: 80,id:'param6'},
		{header: '应答码说明',dataIndex: 'reserve1',width: 100,id:'reserve1'},
		{header: '拒绝原因',dataIndex: 'refuseInfo',width: 250},
		{header: '拒绝人',dataIndex: 'oprID',width: 100}
	]);
