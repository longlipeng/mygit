Ext.onReady(function() {
	...
	var reasonStore = new Ext.data.Store({
		...
		reader: new Ext.data.JsonReader({
			...
			{name: 'reserve1',mapping: 'reserve1'}	//20140219修改存储卡类型
		])
	});
	...
	var reasonColModel = new Ext.grid.ColumnModel([
		...
		{header: '所属机构',dataIndex: 'param1',width: 80,id:'param1'},
		{header: '商户MCC码',dataIndex: 'param2',width: 80,id:'param2'},
		{header: '商户号',dataIndex: 'param3',width: 80,id:'param3'},
		{header: '商户终端号',dataIndex: 'param4',width: 80,id:'param4'},
		{header: '卡类型',dataIndex: 'reserve1',width: 80,id:'reserve1'},
		{header: '机构MCC码',dataIndex: 'param5',width: 80,id:'param5'},
		{header: '机构商户号',dataIndex: 'param6',width: 100,id:'param6'},
