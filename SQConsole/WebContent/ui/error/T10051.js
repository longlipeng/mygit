...
Ext.onReady(function() {// 可选机构数据集
	...
	var gridStore = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({
			url: 'gridPanelStoreAction.asp?storeId=transhangshenhe'
		}),
	...
	var brhColModel = new Ext.grid.ColumnModel([
		...
		//交易卡号
		{header: '系统参考号',dataIndex: 'flownum',width: 100},
		{header: '系统流水号',dataIndex: 'txnssn',width: 100},
		{header: '挂账标志',dataIndex: 'hangflag',width: 100,renderer:statue},
