Ext.onReady(function() {
	...
	var termColModel = new Ext.grid.ColumnModel([
		...
		{header: '商户编号',dataIndex: 'mchntName',width: 350},
		{header: '终端状态',dataIndex: 'termSta',width: 150,renderer: termSta,sortable:true},
		{header: '添加日期',dataIndex: 'recCrtTs',width: 150,renderer: formatDt}
	]);
	...
	var stopMenu = {
		...
		disabled: true,
		handler:function() {
			showConfirm('确定停用吗？',grid,function(bt) {
				if(bt == 'yes') {
