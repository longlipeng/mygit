...
//		{header: 'POS商户编号',dataIndex: 'misc',width: 100,hidden:true},
		...
		{header: '受理机构',dataIndex: 'brhId',width: 90,renderer: agencyRen},
		...
		buttons: [{
			...
			handler: function() {
	        	...
	        	if(monitorForm.getForm().isValid()){
	        		...
	        		task.interval=rate*1000;  //10000*1000=10,000,000
	        		Ext.TaskMgr.start(task);
	        		monitorWin.hide();
	        		Ext.getCmp('monitorBt').enable();
