Ext.onReady(function() {
	...
	var reasonColModel = new Ext.grid.ColumnModel([
		...
		{header: '分公司编号',dataIndex: 'param1',width: 150,id:'param1'},
		{header: '分公司名称'/*,hidden:true*/,dataIndex: 'param2',width: 150,id:'param2'},
		{header: '分公司地址',dataIndex: 'param3',width: 150,id:'param3'},
		{header: '分公司所属地区',dataIndex: 'param4',width: 150,id:'param4'},
		{header: '分公司邮编',dataIndex: 'param5',width: 150,id:'param5'},
		{header: '备注',dataIndex: 'param6',width: 150,id:'param6'}
