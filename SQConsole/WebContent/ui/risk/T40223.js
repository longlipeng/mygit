Ext.onReady(function() {
	...
	function txnChannel(val){
		if(ChannelStore.query("valueField",val).first().data != null)
	...
	var reasonColModel = new Ext.grid.ColumnModel([
		...
		{header: '渠道号',dataIndex: 'param1',width: 100,id:'param1'	,renderer:txnChannel},
		{header: '卡bin',dataIndex: 'param2',width: 100,id:'param2'},
		{header: '交易码',dataIndex: 'param3',width: 150,id:'param3',renderer:txnRen}
	]);
