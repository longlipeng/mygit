Ext.onReady(function() {
	...
	var reasonStore = new Ext.data.Store({
		...
		reader: new Ext.data.JsonReader({
			...
			{name: 'param6',mapping: 'param6'}           //风险规则
		])
	});
	...
	SelectOptionsDWR.getComboData('REFUSE_TYPE2',function(ret){
	...
	var reasonColModel = new Ext.grid.ColumnModel([
		...
		{header: '卡号',dataIndex: 'param1',width: 120,id:'param1'},
		{header: '风险规则',dataIndex: 'param6',width: 80},
	...
	var expMenu = {
			...
			handler:function() {
				...
				Ext.Ajax.requestNeedAuthorise({
					...
					timeout : 600000000,
					params: {
						idCardNo: queryForm.findById('idCardNo').getValue(),
