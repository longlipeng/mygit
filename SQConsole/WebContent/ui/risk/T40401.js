...
Ext.onReady(function() {
	...
	var mchntColModel = new Ext.grid.ColumnModel([
	    ...
	    {header: '营业执照号',dataIndex: 'LICENSE_NO',width: 80},
	    {header: '组织机构代码',dataIndex: 'ORG_CODE',width: 80},
	    {header: '法人身份证号码',dataIndex: 'IDENTITY',width: 100},
		{header: '商户得分',dataIndex: 'score',width: 60},
	    {header: '商户风险等级',dataIndex: 'grade',width: 80},
	    {header: '创建时间',dataIndex: 'createtime',width: 120,renderer:formatTs},
	    {header: '商户风险描述',dataIndex: 'reserve',width: 500}/*,
	...
	var delMenu = {
		...
		disabled: true,
		handler:function() {
			showConfirm('您确定要删除吗？',mchntGrid,function(bt) {
				 delBack() 
			});
		}
	};
