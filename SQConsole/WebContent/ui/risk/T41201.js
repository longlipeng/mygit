Ext.onReady(function() {
	...
	var reasonStore = new Ext.data.Store({
		...
		reader: new Ext.data.JsonReader({
			...
			{name: 'param1',mapping: 'param1'},          //商户编号
			{name: 'param2',mapping: 'param2'},          //申请人
			{name: 'param3',mapping: 'param3'},          //申请时间
			{name: 'reserve1',mapping: 'reserve1'},          //申请备注
			{name: 'param4',mapping: 'param4'},          //当前状态
			{name: 'param5',mapping: 'param5'}           //添加方式
		])
	});
	...
	var reasonColModel = new Ext.grid.ColumnModel([
		...
		{header: '商户编号 - 商户名称',dataIndex: 'param1',width: 240,renderer:function(val){return getRemoteTrans(val, "mchtIdName");}},
		{header: '添加方式',dataIndex: 'param5',width: 80,renderer:addType},
		{header: '操作类型',dataIndex: 'refuseType',renderer: riskInfoRefuseState},
		//
		{header: '申请时间',dataIndex: 'param3',width: 120,renderer: formatTs},
		//
		{header: '申请人',dataIndex: 'param2',width: 120},
		{header: '申请备注',dataIndex: 'reserve1',width: 230},
		...
		{header: '当前状态',dataIndex: 'param4',width: 100,renderer: riskInfoState}
