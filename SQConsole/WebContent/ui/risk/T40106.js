Ext.onReady(function() {
	...
	var reasonColModel = new Ext.grid.ColumnModel([
		...
		{header: '有效天数N',dataIndex: 'param1',width: 70,id:'param1'},
		{header: '使用标识',dataIndex: 'param2',width: 80,id:'param2'},
		{header: '受控动作',dataIndex: 'param3',width: 80,id:'param3'},
		{header: '受控交易笔数',dataIndex: 'param4',width: 100,id:'param4'},
		{header: '受控金额',dataIndex: 'param5',width: 80,id:'param5'}
	]);
