Ext.onReady(function() {
	...
	var reasonColModel = new Ext.grid.ColumnModel([
		...
		{header: '渠道号',dataIndex: 'param2',width: 150,id:'param2',renderer:txnChannel},
		{header: '业务类型',dataIndex: 'param3',width: 150,id:'param3',renderer:serverRen},
		{header: '交易号码',dataIndex: 'param4',width: 150,id:'param4',renderer:txnRen}
	]);
