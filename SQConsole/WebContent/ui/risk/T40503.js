Ext.onReady(function() {
	...
	var reasonColModel = new Ext.grid.ColumnModel([
		...
		{header: '规则编号',dataIndex: 'param1',width: 150,id:'param1'},
		{header: '分公司编号',dataIndex: 'param2',width: 150,id:'param2'},
		{header: '商户类别',dataIndex: 'param3',width: 150,id:'param3'},
		{header: '预警系数',dataIndex: 'param4',width: 150,id:'param4'},
		{header: '预警笔数',dataIndex: 'param5',width: 150,id:'param5'},
		{header: '预警金额',dataIndex: 'param6',width: 150,id:'param6'}
