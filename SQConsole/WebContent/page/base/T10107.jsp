...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/base/AgencyDetail.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/base/T10107.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/dwr/interface/T10106.js"></script>
...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/base/AgencyFeeDetailS.js"></script>
