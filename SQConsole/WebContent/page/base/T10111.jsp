...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/base/AgencyFeeDetail.js"></script>
...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/base/T10111.js"></script>
