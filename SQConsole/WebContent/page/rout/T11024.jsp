...
<title>中行终端通道审核</title>
<script type="text/javascript">
var owner = '<%=request.getParameter("owner")%>';
</script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/rout/T11024.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ext/ux/RowExpander.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/rout/termChannelDetail.js"></script>
