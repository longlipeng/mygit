...
<title>交行终端通道审核</title>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/rout/T11021.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ext/ux/RowExpander.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/rout/jhTermChannelDetail.js"></script>
