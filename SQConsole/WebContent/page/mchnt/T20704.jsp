...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/HisDiscDetail.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/T20704.js"></script>
