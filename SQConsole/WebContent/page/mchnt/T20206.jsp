...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/T20206.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/MchntAudit4Upd.js"></script>
