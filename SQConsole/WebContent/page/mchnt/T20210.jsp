...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/T20210.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/MchntAudit4Def.js"></script>
