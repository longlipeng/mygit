...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/T20201.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/MchntDetailS.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/MchntDetailS4Add.js"></script>
