...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/HisDiscDetailS.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/mchnt/T20705.js"></script>
