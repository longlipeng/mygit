...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/risk/T12103.js"></script>
<link rel="stylesheet" type="text/css" href="<%= request.getContextPath()%>/ext/resources/css/UploadDialog.css">
<style type="text/css">
	.card {
		background-image: url(<%= request.getContextPath()%>/ext/resources/images/risk_card_16.png) !important;
	}
	.upload {
