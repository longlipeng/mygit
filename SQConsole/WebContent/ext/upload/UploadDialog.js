...
//					returnValue = '<span id="' + record.id + '"><div id="fileId_' + record.data.fileId + '" class="ux-cell-icon-delete"/></span>';
					returnValue = '<div id="' + record.id + '"><div id="fileId_' + record.data.fileId + '" class="ux-cell-icon-delete"/></div>';
					break;
...
//					returnValue = '<span id="' + record.id + '"><div id="fileId_' + record.data.fileId + '" class="ux-cell-icon-clear"/></span>';
					returnValue = '<div id="' + record.id + '"><div id="fileId_' + record.data.fileId + '" class="ux-cell-icon-clear"/></div>';
					break;
				case SWFUpload.FILE_STATUS.COMPLETE:
//					returnValue = '<span id="' + record.id + '"><div id="fileId_' + record.data.fileId + '" class="ux-cell-icon-completed"/></span>';
					returnValue = '<div id="' + record.id + '"><div id="fileId_' + record.data.fileId + '" class="ux-cell-icon-completed"/></div>';
					break;
				default : 
					alert('没有设置图表状态');
					break;
		...
		onUploadError : function(file, errorCode, message){
			...
			Ext.MessageBox.show({
				msg: '文件上传失败：' + message + "，错误码：" + errorCode,//20121105 modify
				title: '错误提示',
