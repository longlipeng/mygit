...
public class HttpClient {
	 ...
	 * @throws Exception
	 */
	public int sendJsonString(Map<String,String> data, String encoding) throws Exception {
		try {

			HttpURLConnection httpURLConnection = createConnectionPost(encoding);
			if (null == httpURLConnection) {
				LogUtil.writeErrorLog("创建连接失败");
				throw new Exception("Create httpURLConnection Failure");
			}
			String sendData = this.hashMapToJson(data);
//			sendData = "{\"insSeq\":\"01\",\"backUrl\":\"https://notifyAddress.com/rcv\",\"signature\":\"\",\"payeeAcctName\":\"测试机构1备付金账户\",\"txnType\":\"01\",\"remark\":\"备款\",\"certId\":\"68719767697\",\"encoding\":\"UTF-8\",\"acqInsCode\":\"12345600\",\"version\":\"1.0.0\",\"payeeAcctNo\":\"0000300000000029\",\"txnNo\":\"2018090520392225700000\",\"reserved\":\"\",\"reqReserved\":\"\",\"sndTime\":\"203922\",\"currencyCode\":\"156\",\"signMethod\":\"01\",\"txnDate\":\"20180905\",\"txnAmt\":\"1\"}";
			httpURLConnection.setRequestProperty("Content-Length",String.valueOf(sendData.getBytes().length));
			LogUtil.writeLog("请求报文:[" + sendData + "]");
	...
	private void requestServer(final URLConnection connection, String message, String encoder)
		...
		try {
			...
			LogUtil.writeErrorLog("HTTP Post发送消息失败" + e);
			throw e;
		} finally {
			if (null != out) {
				out.close();
	...
	private String response(final HttpURLConnection connection, String encoding)
		...
		try {
			...
			LogUtil.writeErrorLog("显示Response消息失败" + e);
			throw e;
		} finally {
			if (null != br) {
				br.close();
