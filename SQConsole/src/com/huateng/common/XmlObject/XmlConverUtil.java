...
public class XmlConverUtil {
	...
	public static String maptoXml(Map map,String key) {
		...
		Element nodeElement = document.addElement(key);
		for (Object obj : map.keySet()) {
			Element keyElement = nodeElement.addElement(String.valueOf(obj));
//			keyElement.addAttribute("label", String.valueOf(obj));
			keyElement.setText(String.valueOf(map.get(obj)).trim());
		}
...
//				keyElement.addAttribute("label", String.valueOf(i));
	 ...
	 public static void main(String[] args) throws Exception{
		 XmlConverUtil aa = new XmlConverUtil();
		 List list = new ArrayList();
	     Map map= new HashMap();
	     map.put("id", "21");
	     map.put("name", "junqing");
	     map.put("eat", "fan");
	     list.add(map);
	     Map map2 =new HashMap();
	     map2.put("id", "23");
	     map2.put("name", "guanjun");
	     map2.put("eat", "mian");
	    
	     list.add(map2);
//	     System.out.print(aa.listtoXml(list));
	     System.out.print(aa.maptoXml(map2,"key"));
	...
	public static String doc2String(Document document) {
		...
		return s.substring(38,s.length()).trim();
	}
}
