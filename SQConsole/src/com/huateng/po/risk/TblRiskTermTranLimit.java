...
public class TblRiskTermTranLimit implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((limitOld == null) ? 0 : limitOld.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TblRiskTermTranLimit other = (TblRiskTermTranLimit) obj;
		if (bussType == null) {
		...
		if (limit == null) {
			...
			return false;
		if (limitOld == null) {
			if (other.limitOld != null)
				return false;
		} else if (!limitOld.equals(other.limitOld))
			return false;
		if (oprID == null) {
			if (other.oprID != null)
				return false;
