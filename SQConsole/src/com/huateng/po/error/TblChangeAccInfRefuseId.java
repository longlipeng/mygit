...
public class TblChangeAccInfRefuseId implements java.io.Serializable {
	...
	/** default constructor */
	public TblChangeAccInfRefuseId() {
	}

	/** full constructor */
	public TblChangeAccInfRefuseId(String changeDate, String mchtNo, String termId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblChangeAccInfRefuseId))
			return false;
		TblChangeAccInfRefuseId castOther = (TblChangeAccInfRefuseId) other;
