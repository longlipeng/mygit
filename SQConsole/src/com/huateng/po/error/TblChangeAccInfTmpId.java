...
/**
 * TblChangeAccInfTmpId entity. @author MyEclipse Persistence Tools
 */

public class TblChangeAccInfTmpId implements java.io.Serializable {
	...
	/** default constructor */
	public TblChangeAccInfTmpId() {
	}

	/** full constructor */
	public TblChangeAccInfTmpId(String changeDate, String mchtNo, String termId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblChangeAccInfTmpId))
			return false;
		TblChangeAccInfTmpId castOther = (TblChangeAccInfTmpId) other;
