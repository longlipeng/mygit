...
import java.io.Serializable;
	...
	//	this.TRAN_TYPE=info.getTRAN_TYPE();
		...
		this.FEE_FLAG=info.getFEE_FLAG();
		this.FEE_VALUE=info.getFEE_VALUE();
		this.MAX_FEE=info.getMAX_FEE();
		this.MIN_FEE=info.getMIN_FEE();
		this.MIN_TRADE=info.getMIN_TRADE();
		...
		this.feeflagname=feeflagname;      //费率方式
...
/*	public String getTRAN_TYPE() {
	...
	private AgencyInfoPK agencyInfoPK;
...
//	public  String TRAN_TYPE;//交易联接类型
	...
	public String EXTENSION_FIELD1;//日切
	public String EXTENSION_FIELD2;//超时时间
	...
	public AgencyInfoPK getAgencyInfoPK() {
		return agencyInfoPK;
	}
	public void setAgencyInfoPK(AgencyInfoPK agencyInfoPK) {
		this.agencyInfoPK = agencyInfoPK;
	}
	/**
