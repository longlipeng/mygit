...
public class TblCityCode implements Serializable {
	 ...
	 */
	public TblCityCode (java.lang.String cityCodeNew) {
	 ...
	 * Constructor for primary key
	 */
	public TblCityCode (String cityCodeNew,String cityName) {
		this.setCityCodeNew(cityCodeNew);
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof TblCityCode)) return false;
			...
			if (null == this.getCityCodeNew() || null == cstCityCode.getCityCodeNew()) return false;
			else return (this.getCityCodeNew().equals(cstCityCode.getCityCodeNew()));
		}
	}
