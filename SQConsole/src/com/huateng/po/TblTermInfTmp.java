...
public class TblTermInfTmp implements Serializable {
	 ...
	 */
	public TblTermInfTmp (
		com.huateng.po.TblTermInfTmpPK id,
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.huateng.po.TblTermInfTmp)) return false;
		else {
	...
	public Serializable clone()
	{
		...
		tblTermInf.setDepositAmt(this.deposit);
		...
		tblTermInf.setProvince(this.province);
		tblTermInf.setCity(this.city);
		tblTermInf.setArea(this.area);
		tblTermInf.setCityCode(this.cityCode);
