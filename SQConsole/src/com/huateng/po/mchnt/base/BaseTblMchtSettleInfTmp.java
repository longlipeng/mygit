...
//	对私账号开户行所在市  corp_bank_city
	 ...
	 */
	public BaseTblMchtSettleInfTmp (com.huateng.po.mchnt.TblMchtSettleInfPK id) {
		this.setId(id);
		initialize();
	}
...
//	对私账号开户行所在市  corp_bank_city
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.huateng.po.mchnt.TblMchtSettleInfTmp)) return false;
			...
			if (null == this.getId() || null == tblMchtSettleInfTmp.getId()) return false;
			else return (this.getId().equals(tblMchtSettleInfTmp.getId()));
		}
	}
