...
public class TblTermKeyPK implements Serializable {
	 ...
	 * @param termId2
	 */
	public TblTermKeyPK(String mchntId, String termId) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.huateng.po.TblTermKeyPK)) return false;
		else {
			com.huateng.po.TblTermKeyPK mObj = (com.huateng.po.TblTermKeyPK) obj;
