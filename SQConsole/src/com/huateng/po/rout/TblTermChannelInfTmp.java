...
/**
 * mapping table TBL_TERM_CHANNEL_INF终端通道配置信息表
 * @author crystal
 *
 */
public class TblTermChannelInfTmp implements Serializable {
	...
	private String insMchtOld;//修改前的机构商户号
	private String insTermOld;//修改前的机构终端号
	private String reserve01;//预留域
	private String reserve02;//预留域
	private String lmk;//终端主密钥
	private String channelType;
	private Long minAmt;  //交易金额下限
	private Long maxAmt;  //交易金额上限
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TblTermChannelInfTmp other = (TblTermChannelInfTmp) obj;
		if (checkOprId == null) {
