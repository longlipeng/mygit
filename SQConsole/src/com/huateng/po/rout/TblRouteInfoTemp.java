...
public class TblRouteInfoTemp implements Serializable {
...
private static final long serialVersionUID = 1L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TblRouteInfoTemp other = (TblRouteInfoTemp) obj;
		if (areaNo == null) {
	...
	public Serializable clone(TblRouteInfo tblRouteInfo) {
		tblRouteInfo.setReserved(this.reserved);
		tblRouteInfo.setAreaNo(this.areaNo);
		tblRouteInfo.setBussType(this.bussType);
		tblRouteInfo.setCardBin(this.cardBin);
		tblRouteInfo.setChannel(this.channel);
		tblRouteInfo.setCheckId(this.checkId);
		tblRouteInfo.setCheckTime(this.checkTime);
		tblRouteInfo.setCreatorId(this.creatorId);
		tblRouteInfo.setDestInstId(this.destInstId);
		tblRouteInfo.setMchntId(this.mchntId);
		tblRouteInfo.setSaState(this.saState);
		tblRouteInfo.setUpdateTime(this.updateTime);
		tblRouteInfo.setTxnNum(this.txnNum);
		tblRouteInfo.setCreTime(this.creTime);
		tblRouteInfo.setCreOprId(this.creOprId);
		tblRouteInfo.setCardType(this.cardType);
		tblRouteInfo.setMaxAmt(this.maxAmt);
		tblRouteInfo.setMinAmt(this.minAmt);
		tblRouteInfo.setMchtMcc(this.mchtMcc);
		return tblRouteInfo;
	}
}
