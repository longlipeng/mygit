...
public class T41201ExpAction extends ReportBaseAction{
	...
	protected void reportAction() throws Exception {
		...
		reportCreator.initReportData(getJasperInputSteam("T41201.jasper"), parameters, 
				reportModel.wrapReportDataSource(), getReportType());
		
		if(Constants.REPORT_EXCELMODE.equals(reportType))
			fileName = SysParamUtil.getParam(SysParamConstants.TEMP_FILE_DISK) + "RN41201RN_" + 
		...
		reportCreator.exportReport(outputStream, SysParamUtil.getParam("RN41201RN"));
	...
	protected String genSql() {
		...
		if(isNotEmpty(mchtNo_query)){
			whereSql += " and PARAM1 like '%" + mchtNo_query + "%'";
		}
		...
		sb.append("SELECT PARAM1,PARAM5,REFUSE_TYPE,PARAM3,PARAM2,RESERVE1,TXN_TIME,OPR_ID,REFUSE_INFO,PARAM4 FROM tbl_risk_refuse")
		  .append(whereSql);
	...
	private String mchtNo_query;


	private String getMchtNo_query() {
		return mchtNo_query;
	}

	public void setMchtNo_query(String mchtNo_query) {
		this.mchtNo_query = mchtNo_query;
	}
