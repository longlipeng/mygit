...
//	private String reportType ;//报表类型
	...
	protected String genSql() {
		...
		sql = "select MCHT_NO ,MCHT_NM ,RISL_LVL ,MCHT_STATUS,MANU_AUTH_FLAG ,DISC_CONS_FLG ,PASS_FLAG ,SPELL_NAME ,AREA_NO ,ADDR ,MCC ,MCHT_GRP ,MCHT_GROUP_FLAG   from TBL_MCHT_BASE_INF_TMP "+ whereSql;
		return sql;
	}
	...
	protected void reportAction() throws Exception {
		...
		reportCreator.initReportData(getJasperInputSteam("T50301.jasper"),
		...
		reportCreator.exportReport(outputStream, "商户对账单日表");
