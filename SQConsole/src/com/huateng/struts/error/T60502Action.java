...
public class T60502Action  extends ReportBaseAction  {
	...
	protected void reportAction() throws Exception {
		String[] title = { "ROW_ID", "BRH_ID", "MCHNT_CD", "MCHNT_NM",
				"MCHNT_TYPE", "TERMINAL_CODE", "TERM_TP",
				"MCHNT_MANAGER_CD", "R1", "R2", "R3", "R4", "R5", "R6",
				"R7", "R8"};
