...
public class ManageServiceImpl implements ManageService {
	@WebServiceRef(wsdlLocation = "http://localhost:7001/ShangQiGateWayService/manageService?wsdl")
	...
	public String sendServece(String ctx, String req) {
		 ...
		 * 设置xml转换格式
		 */
		logger.info("请求报文头"+ctx);
		logger.info("请求报文体"+req);
