...
import static com.allinfinance.framework.constant.ConstCode.*;
...
public class ServiceTarget implements Serializable {
    ...
    static {
        ...
        //根据卡号查询订单类型
        map.put("201709251601", "ransomOrderService!getOrderTypeByCardNo");
        ...
        /*中石油余额查询*/
        map.put("201508041", "sendMsgToPospService!accountBalanceQuery");
        /*中石油账户转充*/
        map.put("201508042", "sendMsgToPospService!accountConsum");
        /*微信端客户申请状态查询 20150813001*/
        map.put("20150813001", "ApplyAndBindCardService!lookApplyStatusForWeiXin");
        
        /*中石油绑卡 20150826001*/
        map.put("20150826001", "ApplyAndBindCardService!bindCardToPetroChina");
        /*消费记录交易查询*/
        map.put("201509021", "sendMsgToPospService!queryConsume");
        /*食堂充值*/
        map.put("201511241", "sendMsgToPospService!canteenRecharge");
        /*商户消费*/
        map.put("201606121", "sendMsgToPospService!consumeMall");
        /*商户退货申请*/
        map.put("201607221", "sendMsgToPospService!consumeMallCancel");
        /*商户退货申请状态查询*/
        map.put("201608191", "sendMsgToPospService!queryConsumeMallCancelState");
        /*中石油权益账户交易*/
        map.put("2017062701", "ApplyAndBindCardService!equityAccountTranChina");
        
        //门户更新客户持卡人信息
        map.put("2017080101", "customerService!updateCustomerForGateway");
