...
public class SendMail {
	...
	public String sendmail() {
		...
		try {
			...
			// mailconfig.getSendHost());// 存储发送邮件服务器
	...
	// 添加多个附件
	// private void TianJiaFuJian() throws MessagingException,
	// IOException {
	...
	// // 加上文件名将作为附件发送,否则将作为信件的文本内容;
	// // MimeUtility.encodeText()函数是把中文的文件名转换为base64编码,可以用
	// mdp.setFileName(MimeUtility.encodeText(fujianFileName.get(i)));
