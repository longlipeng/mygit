...
public class AccCardInfoDaoImpl extends SqlMapClientDaoSupport implements AccCardInfoDao {
	...
	public String getQueryPin(CardManagementDTO dto) {
		...
		Object object = this.getSqlMapClientTemplate().queryForObject("TB_ACC_CARD_INFO.selectQueryPin",dto);
		return (String)object;
	}

	@Override
	public void update(CardManagementDTO dto) {
		this.getSqlMapClientTemplate().update("TB_ACC_CARD_INFO.updateTxnPin",dto );
