...
public class Config {
	...
	private static String imgFileWebserviceUrl;
	
	private static String imgFileWebserviceNamespace;
	
	private static String imgFileWebserviceFunction;
...
//  		FileInputStream inputStream = new FileInputStream(configFileName);
  		...
  		imgFileWebserviceUrl=properties.getProperty("imgFileWebserviceUrl");
  		imgFileWebserviceNamespace=properties.getProperty("imgFileWebserviceNamespace");
  		imgFileWebserviceFunction=properties.getProperty("imgFileWebserviceFunction");
  	}

  	
  	public static String getImgFileWebserviceUrl() {
  		if(imgFileWebserviceUrl == null){
  			loadConfig();
  		}
		return imgFileWebserviceUrl;
	}

	public static String getImgFileWebserviceNamespace() {
		if(imgFileWebserviceNamespace == null){
  			loadConfig();
  		}
		return imgFileWebserviceNamespace;
	}

	public static String getImgFileWebserviceFunction() {
		if(imgFileWebserviceFunction == null){
  			loadConfig();
  		}
		return imgFileWebserviceFunction;
	}
