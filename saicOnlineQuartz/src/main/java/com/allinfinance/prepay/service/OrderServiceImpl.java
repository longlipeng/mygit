...
public class OrderServiceImpl implements OrderService {
	...
	public void countTotalPriceForSellOrderUnsign(String orderId)
		...
		sellOrderMapper.updateByExampleSelective(sellOrder, example);
	}
	...
	@Override
	public SellOrderListDTO insertOrderListForSellOrderUnsign(
			SellOrderListDTO sellOrderListDTO) throws BizServiceException {
		try{
			// TODO Auto-generated method stub
			SellOrderList sellOrderList = new SellOrderList();
			...
			this.countTotalPriceForSellOrderUnsign(sellOrderListDTO
							.getOrderId());
