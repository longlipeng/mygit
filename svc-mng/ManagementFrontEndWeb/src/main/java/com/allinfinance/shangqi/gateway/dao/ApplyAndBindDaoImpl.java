...
public class ApplyAndBindDaoImpl  extends SqlMapClientDaoSupport implements ApplyAndBindDao{
	...
	@Override
	public CardholderDTO getCardholderDTO(String statement,
			CardholderDTO cardholderDTO)throws SQLException {

		CardholderDTO dto =  (CardholderDTO) getSqlMapClientTemplate().queryForObject(statement, cardholderDTO);
			return dto;
		
	}
	@Override
	public int getAccCardholderInfoByCardholderId(String statement,
			CardholderDTO cardholderDTO) throws SQLException {
			int dto =  (Integer) getSqlMapClientTemplate().queryForObject(statement, cardholderDTO);
			return dto;
