...
public class OrderConst {
     ...
     * 原订单赎回
     */
    public final static String ORDER_STATE_ORDER_RANSOM = "36";
    /**
     * 营销机构与客户之间的销售记名订单
     */
     ...
     * 订单支付状态：已确定
     */
    public final static String ORDER_PAY_STATE_CONFIRM="2";
     ...
     * 订单流程岗位17:赎回订单入库
     */
    public final static String ORDER_FLOW_RANSOM_STOCK = "17";
    
    
    /***
     * 订单流程岗位:激活订单
     */
    public final static String ORDER_FLOW_ORDER_ACTIVE = "18";
     ...
     * 
     */
    public final static String CARD_STOCK_DESTORYED ="5";
    /**
     * 卡片状态：作废
     * */
    public final static String CARD_STOCK_INVALID = "1";
	...
	/**----------------------------------------------   赎回订单明细卡状态   -------------------------------------------------------------------- */
    /** 原有卡状态1: 未激活但手工标注为销毁 */
    public final static String RANSON_ORIG_CARD_STAT_CHECK = "1";
    /** 原有卡状态2: 未激活可以入库 */
    public final static String RANSON_ORIG_CARD_STAT_ENTSTOCK = "2";
    /** 原有卡状态3: 已激活只能销毁  */
    public final static String RANSON_ORIG_CARD_STAT_DESTORY = "3";
    
	/** 判断激活状态操作 激活销毁,未激活入库 */
	public final static String RANSON_ORIG_CARD_BATCH_ENTSTOCK = "0";
	/** 不判断激活状态操作 直接销毁状态 */
	public final static String RANSON_ORIG_CARD_BATCH_DESTORY = "1";
    /**---------------------------------------------- 赎回订单明细卡状态结束 -------------------------------------------------------------------- */
     ...
     *作废订单数量 
     **/
    public final static String INIT_NUM="0";
    /**
     * 订单明细中--卡片库存状态:入库
     */
    public final static String ORDER_CARD_STOCK_IN = "1";
    
    /**
     * 订单明细中--卡片库存状态:待出库
     */
    public final static String ORDER_CARD_STOCK_READY_OUT = "2";
    
    /**
     * 订单明细中--卡片库存状态:已出库
     */
    public final static String ORDER_CARD_STOCK_OUT = "3";
