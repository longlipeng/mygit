...
public class SendShortMessageThread extends Thread {
	...
	public SendShortMessageThread(String entityId,String telephone ,String templet_No){
		this.entityId = entityId;
		this.telephone = telephone;
		this.templet_No = templet_No;
	}
	public SendShortMessageThread(String entityId,String telephone ,String templet_No,String comment){
		this(entityId,telephone,templet_No);
	...
	public void run() {
		String rsp = toShortMessageService(entityId,telephone ,templet_No,comment);
	 ...
	 * @return
	 */
	public String toShortMessageService(String entityId,String telephone ,String templet_No,String comment){
		...
		try {  
        	...
        	downNoteXML.setOrgId(entityId);//机构号
