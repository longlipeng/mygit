...
public class Const {
	...
	//制卡订单交易代码
	public static final String TXN_TYPE_CODE_MAKE_CARD = "0001";
	
	//充值激活交易代码
	public static final String TXN_TYPE_CODE_RECHARGE = "0002";
	
	//激活交易代码
	public static final String TXN_TYPE_CODE_ACT = "0003";
	
	//充值订单交易代码
	public static final String TXN_TYPE_CODE_RECHARGE_ORDER = "0004";
	
	//赎回订单交易代码
	public static final String TXN_TYPE_CODE_RANSOM_ORDER = "0006";
	...
	//面额代码转换 key-面额 value-code
	public static  Map<String,String> faceCode = new HashMap<String, String>();
	static{
		faceCode.put("0", "00");
		faceCode.put("10000", "01");
		faceCode.put("20000", "02");
		faceCode.put("30000", "03");
		faceCode.put("40000", "04");
		faceCode.put("50000", "05");
		faceCode.put("60000", "06");
		faceCode.put("70000", "07");
		faceCode.put("80000", "08");
		faceCode.put("90000", "09");
		faceCode.put("100000", "10");
	}
}
