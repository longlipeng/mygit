...
public class ApplyAndBindCardDTO extends PageQueryDTO{
	...
	//是不是车享家（清算文件下载时分车享家和非车享家）
	private String isCheXiang;
	...
	public String getIsCheXiang() {
		return isCheXiang;
	}
	public void setIsCheXiang(String isCheXiang) {
		this.isCheXiang = isCheXiang;
	}
