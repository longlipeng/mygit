...
package com.huateng.service.seller.warehouseSummary.service;
 ...
 * 
 */
public class WarehouseSummaryService extends BizBaseService implements
		BizService {
	...
	public List<Object> getList(JSONObject jsonDto) {
		...
		return baseDao.queryForList("warehouseSummary", "warehouseSummary",
