 ...
 * 
 */
public class SellerSellCardInfoDetailService extends BizBaseService implements
		BizService {
	...
	public List<Object> getList(JSONObject jsonDto) {
		...
		list=baseDao.queryForList("sellerSellCardDetail", "sellerSellCardInfoDetail", sisc);
		if(null!=list){
