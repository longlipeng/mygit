 ...
 * <p>
 * <strong>
 * This class name was Base64
 * </strong>
 * </p>
 * @author Lay
 * @date 2010-5-12下午12:58:32
 * @version 1.0
 */
public class Base64 {
	...
	private char mapByteToChar(byte b)
	{
		...
		throw new IllegalArgumentException("Byte " + Integer.valueOf(b) + " is not a valid Base64 value");
	}
...
/*	public static void main(String args[]) throws Exception
	{
		...
		logger.info("Text = [" + tString + "]");
		String tEncoded = Base64.encode(tString.getBytes());
		logger.info("Encoded = [" + tEncoded + "]");
		byte tDecoded[] = Base64.decode(tEncoded);
		logger.info("Decoded = [" + new String(tDecoded) + "]");
	}*/
	...
	private static String getDeCompressedStr(byte[] tMessage)
	{
		...
		{
			logger.error(encodeEx.getMessage());
		}
		return returnStr;
	}
}
