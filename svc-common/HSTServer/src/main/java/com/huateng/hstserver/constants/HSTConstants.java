...
public class HSTConstants {
	...
	//交易系统服务名称
	public final static String[] SVR_TXN = {"vChgKeyServiceTxn",
											"vTxn","vCardTxnInq","vMchntTxnInq","vReloadShmProc","txnCon"};
	
	//账户系统服务名称
	public final static String[] SVR_ACC = {"vCardBatInq",
											"vChgKeyServiceAcc","vMakecard","vCardQry","vRecharge","vRechrgOrder","vAct","Switch","vCardHolderBatInq","accCon","RechargeBat"};
