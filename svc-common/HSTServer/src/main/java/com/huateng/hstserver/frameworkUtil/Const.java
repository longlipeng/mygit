...
public class Const {
	...
	/**
	 * 是否霄1�7要校验密码标讄1�7 1表示霄1�7要校骄1�7 0表示不需要校骄1�7
	 */
	...
	// 对账不平原因
	public static final String RECON_REASON_TRANS_TIME = "交易时间不一臄1�7";
	public static final String RECON_REASON_COMM_MCHNT_ID = "交行商户号不丄1�7臄1�7";
	public static final String RECON_REASON_MCHNT_ID = "得仕商户号不丄1�7臄1�7";
	public static final String RECON_REASON_COMM_POS_ID = "交行终端号不丄1�7臄1�7";
	public static final String RECON_REASON_AMT = "交易金额不一臄1�7";
	public static final String RECON_REASON_TXN_TYPE = "交易类型不一臄1�7";
	public static final String RECON_REASON_SUCC = "对账幄1�7";
